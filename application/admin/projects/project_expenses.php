...
<div class="mb-1 row">
    ...
    <div class="col-auto">
        <?php $this->load->view('admin/expenses/filter_by_template', $data_expenses_filter); ?>
    </div>
...
<div class="modal fade" id="new_project_expense" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <?php echo form_open(admin_url('projects/add_expense'), array('id' => 'project-expense-form', 'class' => '')); ?>
            ...
            <div class="modal-body">
                <div class="dropzone p-0 m-0 no-border">
                    <div id="dropzoneDragArea" class="dz-default dz-message mt-0">
                ...
                <?php echo render_input('expense_name', 'expense_name','','',[],[],'pt-0'); ?>
                ...
                <div class="form-check">
                    <label class="form-check-label">
                        ...
                        <span class="form-check-description" for="billable"><?php echo _l('expense_add_edit_billable'); ?></span>
                    </label>
                </div>
