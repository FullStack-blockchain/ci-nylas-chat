                    ...
                    <div class="page-content p-4 p-sm-6">
                        <div class="content">
                            <div class="row">
                                ...
                                <div class="col-md-7">
                                    <div class="card">
                                        <div class="panel-body">
                                            ...
                                            echo render_input('name', 'project_name', $value, '', [], [], 'no-padding-top'); ?>
                                                ...
                                                <div class="form-check">
                                                    <label class="form-check-label">
                                                        <input class="form-check-input"
                                                               type="checkbox" <?php if ((isset($project) && $project->progress_from_tasks == 1) || !isset($project)) {
                                                            echo 'checked';
                                                        } ?> name="progress_from_tasks" id="progress_from_tasks">
                                                        <span class="checkbox-icon text-success"></span>
                                                        <span class="form-check-description"
                                                              for="progress_from_tasks"><?php echo _l('calculate_progress_through_tasks'); ?></span>
                                                    </label>
                                                </div>
                                            </div>
                                            <?php
                                            ...
                                            <div class="pl-3 pr-3">
                                                <div class="project_progress_slider project_progress_slider_horizontal mt-2"></div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group select-placeholder">
                                            ...
                                            <?php if (total_rows('tblemailtemplates', array('slug' => 'project-finished-to-customer', 'active' => 0)) == 0) { ?>
                                                <div class="form-group project_marked_as_finished hide mt-2 mb-2">
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input class="form-check-input" type="checkbox" name="project_marked_as_finished_email_to_contacts"
                                                                   id="project_marked_as_finished_email_to_contacts">
                                                            <span class="checkbox-icon"></span>
                                                            <span class="form-check-description" for="project_marked_as_finished_email_to_contacts"><?php echo _l('project_marked_as_finished_to_contacts'); ?></span>
                                                        </label>
                                                    </div>
                                                </div>
                                            <?php } ?>
                                            <?php if (isset($project)) { ?>
                                                <div class="form-group mark_all_tasks_as_completed hide">
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input class="form-check-input" type="checkbox"  name="mark_all_tasks_as_completed"
                                                                   id="mark_all_tasks_as_completed">
                                                            <span class="checkbox-icon"></span>
                                                            <span class="form-check-description" for="mark_all_tasks_as_completed"><?php echo _l('project_mark_all_tasks_as_completed'); ?></span>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="notify_project_members_status_change hide">
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            ...
                                                            <span class="checkbox-icon"></span>
                                                            <span class="form-check-description" for="notify_project_members_status_change"><?php echo _l('notify_project_members_status_change'); ?></span>
                                                        </label>
                                                    </div>
                                                    <hr class="mt-4 mb-4"/>
                                                </div>
                                            ...
                                            <p class="bold mb-0"><?php echo _l('project_description'); ?></p>
                                            <?php $contents = '';
                                            if (isset($project)) {
                                                $contents = $project->description;
                                            } ?>
                                            <?php echo render_textarea('description', '', $contents, array(), array(), 'mb-4', 'tinymce'); ?>
                                            <?php if (total_rows('tblemailtemplates', array('slug' => 'assigned-to-project', 'active' => 0)) == 0) { ?>
                                                <div class="form-check">
                                                    <label class="form-check-label">
                                                        <input class="form-check-input" type="checkbox" name="send_created_email"
                                                               id="send_created_email">
                                                        <span class="checkbox-icon"></span>
                                                        <span class="form-check-description" for="send_created_email"><?php echo _l('project_send_created_email'); ?></span>
                                                    </label>
                                                </div>
                                            <?php } ?>
                                        </div>
                                        ...
                                        <div class="panel-body" id="project-settings-area">
                                            ...
                                            <?php foreach ($settings as $setting) { ?>
                                                ...
                                                <?php if ($setting != 'available_features') { ?>
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input class="form-check-input" type="checkbox" name="settings[<?php echo $setting; ?>]" <?php echo $checked; ?>
                                                                   id="<?php echo $setting; ?>">
                                                            <span class="checkbox-icon"></span>
                                                            <span class="form-check-description" for="<?php echo $setting; ?>">
                                                ...
                                                <?php } else { ?>
                                                    <div class="form-group pt-0 mb-4 select-placeholder project-available-features">
                                                        <label for="available_features"><?php echo _l('visible_tabs'); ?></label>
                                                        <select name="settings[<?php echo $setting; ?>][]"
                                                                id="<?php echo $setting; ?>" multiple="true"
                                                                class="selectpicker" id="available_features"
                                                            ...
                                                            <?php foreach ($tabs as $tab) {
                                                                ...
                                                                <?php } else {
                                                                    ...
                                                                    ?>
                                                                    <option value="<?php echo $tab['name']; ?>"<?php if ($tab['name'] == 'project_overview') {
                                ...
                                <div class="project-form-save-buttons">
                                    <button type="submit" data-form="#project_form" class="btn btn-info"
                                            autocomplete="off"
