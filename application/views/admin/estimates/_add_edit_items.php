            ...
            <div class="mt-2">
                ...
                <div class="form-check form-check-inline">
                    <label class="form-check-label">
                        <input class="form-check-input" type="radio" value="1" id="1" name="show_quantity_as"
                        ...
                        <span class="form-check-description" for="1"><?php echo _l('quantity_as_qty'); ?></span>
                    </label>
                </div>
                <div class="form-check form-check-inline">
                    <label class="form-check-label">
                        <input class="form-check-input" type="radio" value="2" id="2" name="show_quantity_as"
                               data-text="<?php echo _l('estimate_table_hours_heading'); ?>" <?php if (isset($estimate) && $estimate->show_quantity_as == 2) {
                            echo 'checked';
                        } ?>>
                        <span class="radio-icon"></span>
                        <span class="form-check-description" for="2"><?php echo _l('quantity_as_hours'); ?></span>
                    </label>
                </div>
                <div class="form-check form-check-inline">
                    <label class="form-check-label">
                        <input class="form-check-input" type="radio" id="3" value="3" name="show_quantity_as"
                        ...
                        <span class="form-check-description"
                              for="3"><?php echo _l('estimate_table_quantity_heading'); ?>
                            /<?php echo _l('estimate_table_hours_heading'); ?></span>
                    </label>
                </div>
            </div>
        </div>
        ...
        <table class="table estimate-items-table items table-main-estimate-edit no-mtop">
            ...
            <tr>
                ...
                <th width="20%" align="left">
                    <i class="fa fa-exclamation-circle text-white line-height-25" aria-hidden="true" data-toggle="tooltip"
            ...
            <tr class="main">
                ...
                <td>
                    ...
                    <button type="button"
                            ...
                            class="btn pull-right btn-info min-height-auto m-t-2"><i class="fa fa-check s-4"></i></button>
                    </div>
                </td>
            </tr>
