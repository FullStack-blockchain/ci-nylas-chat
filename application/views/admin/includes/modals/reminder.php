    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel"><i class="fa fa-question-circle" data-toggle="tooltip"
                                                             title="<?php echo _l('set_reminder_tooltip'); ?>"
                                                             data-placement="bottom"></i> <?php echo $reminder_title; ?>
                </h4>
                        ...
                        <?php if (total_rows('tblemailtemplates', array('slug' => 'reminder-email-staff', 'active' => 0)) == 0) { ?>
                            ...
                            <div class="form-check mt-4">
                                <label class="form-check-label">
                                    ...
                                    <span class="checkbox-icon"><?php echo _l('reminder_notify_me_by_email'); ?></span>
                                    <span></span>
                                </label>
                            </div>
                        <?php } ?>
