        ...
        <div class="panel-body card">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    if ($pr_template || $sms_trigger) { ?>
                        <div class="form-check form-check-inline mt-6">
                            <label class="form-check-label">
                                <input type="checkbox" class="form-check-input" name="do_not_send_email_template"
                                       id="do_not_send_email_template"/>
                                <span class="checkbox-icon"></span>
                                <span class="form-check-description" for="do_not_send_email_template">
                            <?php
                            if ($pr_template) {
                    ...
                    <?php } ?>
                    <div class="form-check form-check-inline mt-4 do_not_redirect hide">
                        <label class="form-check-label">
                            <input class="form-check-input" type="checkbox" name="do_not_redirect" id="do_not_redirect"
                                   checked/>
                            <span class="checkbox-icon"></span>
                            <span class="form-check-description"
                                  for="do_not_redirect"><?php echo _l('do_not_redirect_payment'); ?></span>
                        </label>
                    </div>
                </div>
                <div class="col-md-6">
            ...
            <div class="pull-right mt-4 text-right">
                ...
                <button type="submit" autocomplete="off" data-loading-text="<?php echo _l('wait_text'); ?>"
                        data-form="#record_payment_form" class="btn btn-success text-white"><?php echo _l('submit'); ?></button>
            </div>
            <?php
            if ($payments) { ?>
