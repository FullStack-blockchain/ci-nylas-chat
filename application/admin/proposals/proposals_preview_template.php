...
<div class="panel-body">
    ...
    <div class="row">
        <div class="col-md-3">
            <?php echo format_proposal_status($proposal->status, 'pull-left mt-2'); ?>
        </div>
        <div class="col-md-9 text-right _buttons proposal_buttons">
            ...
            <div class="btn-group ml-1">
                ...
                <ul class="dropdown-menu dropdown-menu-right width200">
                    ...
                    <li>
                        <a href="<?php echo admin_url('proposals/pdf/' . $proposal->id); ?>"><?php echo _l('download'); ?></a>
                    </li>
                    <li>
            ...
            <div class="btn-group ml-1" data-toggle="tooltip" data-title="<?php echo _l('proposal_send_to_email'); ?>"
                 data-placement="bottom">
                <a href="#" class="btn btn-default btn-with-tooltip" data-target="#proposal_send_to_customer"
                   data-toggle="modal"><i class="fa fa-envelope s-4"></i></a>
            </div>
            <div class="btn-group ml-1">
            ...
            <?php if ($proposal->estimate_id == NULL && $proposal->invoice_id == NULL) { ?>
                <?php if (has_permission('estimates', '', 'create') || has_permission('invoices', '', 'create')) { ?>
                    <div class="btn-group ml-1">
                        <button type="button"
                                class="btn btn-success text-white dropdown-toggle<?php if ($proposal->rel_type == 'customer' && total_rows('tblclients', array('active' => 0, 'userid' => $proposal->rel_id)) > 0) {
                                    echo ' disabled';
                            ...
                            <?php if (has_permission('estimates', '', 'create')) { ?>
                                <li <?php if ($disable_convert) {
                                    echo 'data-toggle="tooltip" title="' . _l($help_text, _l('proposal_convert_estimate')) . '"';
                                        ...
                                        echo 'data-template="estimate" onclick="convert_template(this); return false;"';
                            ...
                            <?php if (has_permission('invoices', '', 'create')) { ?>
                                <li <?php if ($disable_convert) {
                                    echo 'data-toggle="tooltip" title="' . _l($help_text, _l('proposal_convert_invoice')) . '"';
                                        ...
                                        echo 'data-template="invoice" onclick="convert_template(this); return false;"';
                ...
                <div role="tabpanel" class="tab-pane active" id="tab_proposal">
                    ...
                    if (count($proposal->attachments) > 0) { ?>
                        ...
                        <?php foreach ($proposal->attachments as $attachment) {
                            ...
                            ?>
                            <div class="mb-3 row" data-attachment-id="<?php echo $attachment['id']; ?>">
                                <div class="col-md-8">
                                ...
                                <div class="col-md-4 text-right">
                                    ...
                                    <a href="#" data-toggle="tooltip"
                                       ...
                                       data-title="<?php echo $tooltip; ?>"><i class="fa <?php echo $icon; ?> s-4"
                    ...
                    <div class="row proposal-comments mtop15">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <textarea name="content" id="comment" rows="4" placeholder="Write here..." class="form-control mb-4 proposal-comment"></textarea>
                            </div>
                ...
                <div role="tabpanel" class="tab-pane" id="tab_reminders">
                    <a href="#" data-toggle="modal" class="btn btn-info"
                       data-target=".reminder-modal-proposal-<?php echo $proposal->id; ?>"><i
                                class="fa fa-bell-o s-4 mr-2"></i> <?php echo _l('proposal_set_reminder_title'); ?></a>
                    <hr class="mt-4 mb-4"/>
                    <?php render_datatable(array(_l('reminder_description'), _l('reminder_date'), _l('reminder_staff'), _l('reminder_is_notified')), 'reminders'); ?>
                    <?php $this->load->view('admin/includes_fuse/modals/reminder', array('id' => $proposal->id, 'name' => 'proposal', 'members' => $members, 'reminder_title' => _l('proposal_set_reminder_title'))); ?>
                </div>
