                    ...
                    <div class="page-header bg-primary text-auto row no-gutters align-items-center justify-content-between p-4">
                        ...
                        <div class="col-md col-sm-12">
                            <div>
                                ...
                                <span class="logo-text h4"><?php echo _l('leads'); ?></span>
                            </div>
                        </div>
                        ...
                        <div class="col-auto ml-4">
                            <?php if (is_admin() || get_option('allow_non_admin_members_to_import_leads') == '1') { ?>
                                <a href="<?php echo admin_url('leads/import'); ?>"
                                   class="btn btn-info pull-right ml-4 display-block hidden-xs">
                                    <?php echo _l('import_leads'); ?>
                                </a>
                            <?php } ?>
                            <a href="#" onclick="init_lead(); return false;"
                               class="btn mright5 btn-info pull-right  display-block">
                            ...
                            <div class="card-body">
                                <div class="_buttons">
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="btn-group">
                                                <a href="#" class="btn btn-default btn-with-tooltip"
                                                   ...
                                                   style="min-height: 3rem !important;"><i
                                        ...
                                        <div class="col-md-4 pull-right leads-search">
                                            <?php if ($this->session->userdata('leads_kanban_view') == 'true') { ?>
                                                <div data-toggle="tooltip" data-placement="bottom"
                                                     data-title="<?php echo _l('search_by_tags'); ?>">
                                                    <?php echo render_input('search', '', '', 'search', array('data-name' => 'search', 'onkeyup' => 'leads_kanban();', 'placeholder' => _l('leads_search')), array(), 'no-margin pt-0', 'pull-right') ?>
                                                </div>
                                            <?php } ?>
                                    ...
                                    <div class="row hide leads-overview">
                                        <hr class="mt-3 mb-3"/>
                                        <div class="col-md-12">
                                            <h4 class="mb-3"><?php echo _l('leads_summary'); ?></h4>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="row">
                                                <?php
                                                    ...
                                                    <div class="col col-md mb-3">
                                                        <div class="fuse-widget-front mat-white-bg mat-elevation-z2 ng-tns-c24-4">
                                                            <div class="p-6 text-center">
                                                                ...
                                                                <div class="h5 f-16 mt-8 font-weight-500 <?php echo isset($status['junk']) || isset($status['lost']) ? 'text-danger' : ''; ?>"
                                                                ...
                                                                <div id="bulk_change">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="tagsinput"
                                                                               id="tags_bulk" name="tags_bulk" value=""
                                                                               data-role="tagsinput">
                                                                    </div>
                                                                    <hr/>
                                                                    <div class="form-group no-mbot">
                                                                        <div class="radio radio-primary radio-inline">
                                                                            <input type="radio"
                                                                                   name="leads_bulk_visibility"
                                                                                   id="leads_bulk_public"
                                                                                   value="public">
                                                ...
                                                $_table_data = array(
                                                    ...
                                                    <div class="form-check mass_select_all_wrap">
                                                        <label class="form-check-label">
                                                            <input type="checkbox" id="mass_select_all" data-to-table="leads" class="form-check-input"/>
