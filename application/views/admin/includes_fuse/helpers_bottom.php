<?php include_once(APPPATH . 'views/admin/includes_fuse/modals/post_likes.php'); ?>
<?php include_once(APPPATH . 'views/admin/includes_fuse/modals/post_comment_likes.php'); ?>
<div id="event"></div>
...
<div class="modal fade task-modal-single" id="task-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
  <div class="modal-dialog <?php echo get_option('task_modal_class'); ?>">
    <div class="modal-content data" style="display: flex !important;">
