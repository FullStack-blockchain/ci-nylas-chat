        ...
        <tbody>
            ...
            <tr class="payment">
                <td><?php echo $payment['paymentid']; ?>
                    <?php echo icon_btn('payments/pdf/' . $payment['paymentid'], 'file-pdf-o','btn-icon-square pull-right'); ?>
                </td>
                ...
                <td>
                    <a href="<?php echo admin_url('payments/payment/'.$payment['paymentid']); ?>" class="btn btn-default btn-icon-square"><i class="fa fa-pencil-square-o s-4"></i></a>
                    <?php if(has_permission('payments','','delete')){ ?>
                    <a href="<?php echo admin_url('invoices/delete_payment/'.$payment['paymentid'] . '/' . $payment['invoiceid']); ?>" class="btn btn-danger btn-icon-square _delete"><i class="fa fa-remove s-4"></i></a>
                    <?php } ?>
                </td>
            </tr>
            <?php } ?>
