<ul class="nav nav-tabs" role="tablist">
    ...
    <li role="presentation" class="nav-item">
        <a href="#signature" aria-controls="general" role="tab" class="nav-link" data-toggle="tab"><?php echo _l('signature'); ?></a>
    </li>
    <li role="presentation" class="nav-item">
        <a href="#formats" aria-controls="invoice" role="tab" class="nav-link" data-toggle="tab"><?php echo _l('pdf_formats'); ?></a>
    </li>
</ul>
                ...
                <div class="row">
                    ...
                    <?php if (has_permission('settings', '', 'delete')) { ?>
                        <div class="col-md-3 text-right">
                            <a href="<?php echo admin_url('settings/remove_signature_image'); ?>"
