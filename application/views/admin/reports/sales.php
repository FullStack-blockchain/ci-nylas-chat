    ...
    <div id="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="content">
                ...
                <div id="manage_sales_reports" class="page-layout simple left-sidebar-floating">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                                ...
                                                <p class="mb-0">
                                                    <a href="#" class="font-medium"
                                                       onclick="init_report(this,'invoices-report'); return false;"><i
                                                                ...
                                                                aria-hidden="true"></i> <?php echo _l('invoice_report'); ?>
                                                    </a>
                                                </p>
                                                <hr class="mb-2"/>
                                                <p class="mb-0">
                                                    <a href="#" class="font-medium"
                                                       onclick="init_report(this,'items-report'); return false;"><i
                                                                class="fa fa-caret-down"
                                                                aria-hidden="true"></i> <?php echo _l('items_report'); ?>
                                                    </a>
                                                </p>
                                                <hr class="mb-2"/>
                                                <p class="mb-0">
                                                    <a href="#" class="font-medium"
                                                       onclick="init_report(this,'payments-received'); return false;"><i
                                                                class="fa fa-caret-down"
                                                                aria-hidden="true"></i> <?php echo _l('payments_received'); ?>
                                                    </a>
                                                </p>
                                                <hr class="mb-2"/>
                                                <p class="mb-0">
                                                    <a href="#" class="font-medium"
                                                       onclick="init_report(this,'credit-notes'); return false;"><i
                                                                class="fa fa-caret-down"
                                                                aria-hidden="true"></i> <?php echo _l('credit_notes_report'); ?>
                                                    </a>
                                                </p>
                                                <hr class="mb-2"/>
                                                <p class="mb-0">
                                                    <a href="#" class="font-medium"
                                                       onclick="init_report(this,'proposals-report'); return false;"><i
                                                                class="fa fa-caret-down"
                                                                aria-hidden="true"></i> <?php echo _l('proposals_report'); ?>
                                                    </a></p>
                                                <hr class="mb-2"/>
                                                <p class="mb-0">
                                                    <a href="#" class="font-medium"
                                                       onclick="init_report(this,'estimates-report'); return false;"><i
                                                                class="fa fa-caret-down"
                                                                aria-hidden="true"></i> <?php echo _l('estimates_report'); ?>
                                                    </a>
                                                </p>
                                                <hr class="mb-2"/>
                                                <p class="mb-0">
                                            ...
                                            <div class="col-md-4 border-right">
                                                ...
                                                <hr class="mt-4 mb-4"/>
                                                <p class="mb-0"><a href="#" class="font-medium"
                                                ...
                                                <p class="mb-0"><a href="#" class="font-medium"
                                                      onclick="init_report(this,'payment-modes'); return false;"><i
                                                                class="fa fa-caret-down"
                                                                aria-hidden="true"></i> <?php echo _l('payment_modes_report'); ?>
                                                    </a>
                                                </p>
                                                <hr class="mb-2"/>
                                                <p class="mb-0"><a href="#" class="font-medium"
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <?php } ?>
                                                <div id="income-years" class="hide mt-5">
                                                ...
                                                <div class="form-group hide pt-0" id="report-time">
                                                ...
                                                <div id="date-range" class="hide mt-5">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                        ...
                                        <div id="report" class="hide">
                                            <hr class="mt-4 mb-4"/>
                                            <h4 class="f-19"><?php echo _l('reports_sales_generated_report'); ?></h4>
                                            <hr class="mt-4 mb-4"/>
