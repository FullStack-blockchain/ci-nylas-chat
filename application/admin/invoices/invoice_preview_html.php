...
<div id="invoice-preview">
    <div class="row">
        ...
        <?php if ($invoice->project_id != 0) { ?>
            <div class="col-md-12">
                <h4 class="font-medium mt-4 mb-4"><?php echo _l('related_to_project', array(
    ...
    <?php if (count($invoice->attachments) > 0) { ?>
        ...
        <?php foreach ($invoice->attachments as $attachment) {
            ...
            ?>
            <div class="mb-3 row inline-block full-width" data-attachment-id="<?php echo $attachment['id']; ?>">
                <div class="col-md-8">
    ...
    <?php if ($invoice->clientnote != '') { ?>
        <div class="col-md-12 row">
            <p class="bold text-muted mr-4"><?php echo _l('invoice_note'); ?></p>
