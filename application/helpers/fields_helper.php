    ...
    <div class="form-group pt-0">
        ...
        <div class="form-check form-check-inline mt-2 ">
            <label class="form-check-label">
                <input type="radio" id="y_opt_1_<?php echo $label; ?>" name="settings[<?php echo $option_value; ?>]" class="form-check-input"
                       value="<?php echo $replace_1 == '' ? 1 : $replace_1; ?>" <?php if (get_option($option_value) == ($replace_1 == '' ? '1' : $replace_1)) {
                    echo 'checked';
                } ?>>
                <span class="radio-icon"></span>
                <span><?php echo $replace_yes_text == '' ? _l('settings_yes') : $replace_yes_text; ?></span>
            </label>
        </div>

        <div class="form-check form-check-inline mt-2 ">
            <label class="form-check-label">
                <input type="radio" id="y_opt_2_<?php echo $label; ?>" name="settings[<?php echo $option_value; ?>]" class="form-check-input"
                       value="<?php echo $replace_0 == '' ? 0 : $replace_0; ?>" <?php if (get_option($option_value) == ($replace_0 == '' ? '0' : $replace_0)) {
                    echo 'checked';
                } ?>>
                <span class="radio-icon"></span>
                <span> <?php echo $replace_no_text == '' ? _l('settings_no') : $replace_no_text; ?></span>
            </label>
        </div>
