                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check mb-1">
                                <label class="form-check-label">
                                    <input type="radio" class="form-check-input" value="all" id="all" checked
                                           name="credit_note_zip_status"/>
                                ...
                                <div class="form-check mb-1">
                                    <label class="form-check-label">
                                        <input type="radio" class="form-check-input"
                                               ...
                                               id="crn_<?php echo $status['id']; ?>" name="credit_note_zip_status"/>
                                        <span class="radio-icon"></span>
                                        <span for="crn_<?php echo $status['id']; ?>"><?php echo $status['name']; ?></span>
                                    </label>
                                </div>
                            <?php } ?>
                        </div>
