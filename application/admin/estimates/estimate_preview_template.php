...
<div class="col-md-12 no-padding">
    <div class="panel-body">
        ...
        <div class="row">
            <div class="col-md-3">
                <?php echo format_estimate_status($estimate->status, 'mt-2'); ?>
            </div>
            <div class="col-md-9">
                ...
                <div class="pull-right _buttons">
                    ...
                    <div class="btn-group ml-1">
                        <a href="#" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"
                           aria-expanded="false"><i class="fa fa-file-pdf-o s-4"></i><?php if (is_mobile()) {
                                echo ' PDF';
                            ...
                            <a href="#" class="estimate-send-to-client btn btn-default btn-with-tooltip"
                               data-toggle="tooltip" title="<?php echo $_tooltip; ?>" data-placement="bottom"><span
                                        data-toggle="tooltip" data-title="<?php echo $_tooltip_already_send; ?>"><i
                                            class="fa fa-envelope s-4"></i></span></a>
                        </div>
                    <?php } ?>
                    <div class="btn-group ml-1">
                    ...
                    <?php if ($estimate->invoiceid == NULL) { ?>
                        <?php if (has_permission('invoices', '', 'create') && !empty($estimate->clientid)) { ?>
                            <div class="btn-group pull-right ml-1">
                                ...
                                <ul class="dropdown-menu width250">
                                    <li>
                    ...
                    <?php } else { ?>
                        <div class="btn-group ml-1">
                            <a href="<?php echo admin_url('invoices/list_invoices/' . $estimate->invoice->id); ?>"
                               ...
                               class="btn btn-info text-white"><?php echo format_invoice_number($estimate->invoice->id); ?></a>
                        </div>
                    <?php } ?>
                </div>
            </div>
        ...
        <div class="tab-content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table class="table items estimate-items-preview mb-5 mt-5">
                                    <thead>
                                    <tr>
                                        <th align="left">#</th>
                        ...
                        <?php if (count($estimate->attachments) > 0) { ?>
                            ...
                            <?php foreach ($estimate->attachments as $attachment) {
                                ...
                                ?>
                                <div class="mb-3 row col-md-12" data-attachment-id="<?php echo $attachment['id']; ?>">
                                    <div class="col-md-8">
                                    ...
                                    <div class="col-md-4 text-right">
                                        ...
                                        <a href="#" data-toggle="tooltip"
                                           ...
                                           data-title="<?php echo $tooltip; ?>"><i class="<?php echo $icon; ?> s-4"
            ...
            <div role="tabpanel" class="tab-pane" id="tab_reminders">
                <a href="#" data-toggle="modal" class="btn btn-secondary"
                   data-target=".reminder-modal-estimate-<?php echo $estimate->id; ?>"><i
                            class="fa fa-bell-o s-4"></i> <?php echo _l('estimate_set_reminder_title'); ?></a>
                <hr class="mt-4 mb-4"/>
                <?php render_datatable(array(_l('reminder_description'), _l('reminder_date'), _l('reminder_staff'), _l('reminder_is_notified')), 'reminders'); ?>
                <?php $this->load->view('admin/includes_fuse/modals/reminder', array('id' => $estimate->id, 'name' => 'estimate', 'members' => $members, 'reminder_title' => _l('estimate_set_reminder_title'))); ?>
            </div>
            <div role="tabpanel" class="tab-pane" id="tab_emails_tracking">
                <?php $this->load->view('admin/includes_fuse/emails_tracking', array('tracked_emails' =>get_tracked_emails($estimate->id, 'estimate')));?>
            </div>
            <div role="tabpanel" class="tab-pane" id="tab_notes">
                ...
                <div class="text-right">
                    <button type="submit"
                            class="btn btn-info mt-3 mb-3"><?php echo _l('estimate_add_note'); ?></button>
                </div>
                <?php echo form_close(); ?>
                <hr class="mb-4"/>
                <div class="mb-4 no-shadow" id="sales_notes_area"></div>
            </div>
                                    ...
                                    <div class="text">
                                        <?php if (is_numeric($activity['staffid']) && $activity['staffid'] != 0) { ?>
                                            <a href="<?php echo admin_url('profile/' . $activity["staffid"]); ?>">
                                                <?php echo staff_profile_image($activity['staffid'], array('staff-profile-xs-image pull-left mr-2'));
                                                ?>
                                            </a>
                                        <?php } ?>
                                        <?php
                                        ...
                                        if (is_admin()) {
                                            echo '<a href="#" class="pull-right text-danger" onclick="delete_sale_activity(' . $activity['id'] . '); return false;"><i class="fa fa-remove text-danger"></i></a>';
                                        }
                                        ?>
                                    </div>
                                </div>
