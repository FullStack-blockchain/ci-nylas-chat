<div class="modal fade email-template" data-editor-id=".<?php echo 'tinymce-' . $contract->id; ?>"
        ...
        <div class="modal-content full-height">
            <div class="modal-header">
                <h4 class="modal-title"
                    id="myModalLabel"><?php echo _l('contract_send_to_client_modal_heading'); ?></h4>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-check">
                            <label class="form-check-label">
                                <input type="radio" class="form-check-input" <?php if (empty($contract->content)) {
                                    echo 'disabled';
                                } else {
                                    echo 'checked';
                                } ?> name="attach_pdf" id="attach_pdf"/>
                                <span class="radio-icon"></span>
                                <span for="attach_pdf"><?php echo _l('contract_send_to_client_attach_pdf'); ?></span>
                            </label>
                        </div>
                            ...
                            <?php foreach ($contract->attachments as $attachment) { ?>
                                <div class="form-check">
                                    <label class="form-check-label">
                                        ...
                                        <span class="radio-icon"></span>
                                        <span><a href="<?php echo site_url('download/file/contract/' . $attachment['attachment_key']); ?>"><?php echo $attachment['file_name']; ?></a></span>
                                    </label>
                                </div>
                            <?php } ?>
                        </div>
