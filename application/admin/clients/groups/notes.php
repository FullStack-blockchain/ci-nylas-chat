...
<div class="col-md-12 p-5">
 ...
 <a href="#" class="btn btn-secondary" onclick="slideToggle('.usernote'); return false;"><?php echo _l('new_note'); ?></a>
...
<div class="row">
 ...
 <div class="usernote hide">
    ...
    <button class="btn btn-info pull-right m-t-10 m-b-15">
        <?php echo _l( 'submit'); ?>
    </button>
    <?php echo form_close(); ?>
</div>
        ...
        <tbody>
            ...
            <tr>
                ...
                <div data-note-edit-textarea="<?php echo $note['id']; ?>" class="hide">
                    <textarea name="description" class="form-control full-width" rows="4"><?php echo clear_textarea_breaks($note['description']); ?></textarea>
                    <div class="text-right m-t-15">
                      <button type="button" class="btn btn-default m-r-10" onclick="toggle_edit_note(<?php echo $note['id']; ?>);return false;"><?php echo _l('cancel'); ?></button>
