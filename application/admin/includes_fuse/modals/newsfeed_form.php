    ...
    <div class="col-md-6 col-md-offset-3">
        ...
        <div class="mb-2">
            <a href="<?php echo admin_url('profile'); ?>">
                <?php echo staff_profile_image($current_user->staffid, array('staff-profile-image-small avatar')); ?>
        ...
        <a href="#" class="btn btn-default add-post-attachments btn-icon-square" data-toggle="tooltip" title="<?php echo _l('newsfeed_upload_tooltip'); ?>">
