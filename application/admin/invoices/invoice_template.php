<div class="<?php if (!isset($invoice) || (isset($invoice) && count($invoices_to_merge) == 0 && (isset($invoice) && !isset($invoice_from_project) && count($expenses_to_bill) == 0 || $invoice->status == 5))) {
    echo ' hide';
} ?>" id="invoice_top_info">
...
<div class="invoice accounting-template">
                        ...
                        <div class="form-check">
                            <label class="form-check-label">
                                <input class="form-check-input"
                                       type="checkbox" <?php if (isset($invoice) && $invoice->cancel_overdue_reminders == 1) {
                                    echo 'checked';
                                } ?> id="cancel_overdue_reminders" name="cancel_overdue_reminders"/>
                                <span class="checkbox-icon text-danger"></span>
                                <span class="form-check-description"
                                      for="cancel_overdue_reminders"><?php echo _l('cancel_overdue_reminders_invoice') ?></span>
                            </label>
                        </div>
                    </div>
                <?php } ?>
                                        ...
                                        <div class="input-group-addon">
                                            <div class="form-check form-check-inline">
                                                <label class="form-check-label">
                                                    ...
                                                    <span class="form-check-description"
                                                          for="unlimited_cycles"><?php echo _l('cycles_infinity'); ?></span>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
    ...
    <div class="panel-body card mt-4">
        <div class="row">
            ...
            <?php if (!isset($invoice_from_project) && isset($billable_tasks)) {
                ?>
                <div class="col-md-3">
                    <div class="form-group pt-0 mb-4 select-placeholder input-group-select form-group-select-task_select popover-250">
            ...
            <div class="col-md-<?php if (!isset($invoice_from_project)) {
                ...
                <div class="mt-2">
                    ...
                    <div class="form-check form-check-inline">
                        <label class="form-check-label">
                            <input class="form-check-input" type="radio" value="1" id="sq_1" name="show_quantity_as"
                            ...
                            <span class="form-check-description" for="sq_1"><?php echo _l('quantity_as_qty'); ?></span>
                        </label>
                    </div>
                    <div class="form-check form-check-inline">
                        <label class="form-check-label">
                            <input class="form-check-input" type="radio" value="2" id="sq_2" name="show_quantity_as"
                    ...
                    <div class="form-check form-check-inline">
                        <label class="form-check-label">
                            <input class="form-check-input" type="radio" value="3" id="sq_3" name="show_quantity_as"
                            ...
                            <span class="radio-icon"></span>
                            <span class="form-check-description"
                                  for="sq_3"><?php echo _l('invoice_table_quantity_heading'); ?>
                                /<?php echo _l('invoice_table_hours_heading'); ?></span>
                        </label>
                    </div>
                </div>
            </div>
        ...
        <div class="table-responsive s_table">
            <table class="table invoice-items-table items table-main-invoice-edit no-mtop">
                ...
                <tr>
                    <th></th>
                    <th width="20%" align="left"><i class="fa fa-exclamation-circle text-white line-height-25"
                                                    aria-hidden="true"
                                                    data-toggle="tooltip"
                    ...
                    <th align="center"><i class="fa fa-cog text-white line-height-25"></i></th>
                </tr>
                </thead>
                <tbody>
                <tr class="main">
    ...
    <div class="panel-body card mt-4">
        <div class="row">
            <div class="col-md-12 bottom-transaction">
