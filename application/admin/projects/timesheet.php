    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><span class="add-title"><?php echo _l('record_timesheet'); ?></span></h4>
                            ...
                            <div class="timesheet-start-end-time">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <label class="control-label"
                                                       for="start_time"><?php echo _l('project_timesheet_start_time'); ?></label>
                                            </div>
                                            <div class="col-md-9">
                                                <?php echo render_datetime_input('start_time', '', '', [], [], 'pt-0'); ?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group mb-0">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <label class="control-label mb-0 pt-1"
                                                       for="end_time"><?php echo _l('project_timesheet_end_time'); ?></label>
                                            </div>
                                            <div class="col-md-9">
                                                <?php echo render_datetime_input('end_time', '', '', [], [], 'pt-0'); ?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="timesheet-duration full-width hide">
                                <div class="col-md-12">
                                    <div class="form-group mb-0">
                                        <div class="row">
                                            <div class="col-md-3 popover-250">
                                                <label class="control-label mb-0 pt-1" for="timesheet_duration">
                                                    <?php echo _l('project_timesheet_time_spend'); ?>
                                                </label>
                                                <i class="fa fa-question-circle pointer" data-toggle="popover"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            <select name="timesheet_task_id" id="timesheet_task_id" class="selectpicker"
