    ...
    <div id="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="content">
                ...
                <div id="manage_staff_timesheets" class="page-layout simple left-sidebar-floating">
                                    ...
                                    <div class="card-body">
                                        <?php if (is_admin()) { ?>
                                            ...
                                            <a href="<?php echo site_url($this->uri->uri_string() . (!isset($view_all) ? '?view=all' : '')); ?>"
                                               class="btn btn-info mb-4"><i class="fa fa-clock-o line-height-20"></i>
                                                <?php
                                            ...
                                            <hr/>
                                        <?php } ?>
                                        <canvas id="timesheetsChart" style="max-height:400px;" width="350"
                                                height="350"></canvas>
                                        <hr class="mt-4 mb-4"/>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="select-placeholder">
                                                    <select name="range" id="range" class="selectpicker"
                                                            data-width="100%">
                                                        <option value="today"
                                                                selected><?php echo _l('today'); ?></option>
                                            ...
                                            <div class="col-md-3">
                                                <div class="select-placeholder">
                                                    <select data-empty-title="<?php echo _l('project'); ?>"
                                                            name="project_id"
                                                            id="project_id" class="projects ajax-search"
                                            ...
                                            <div class="pull-right" id="group_by_tasks_wrapper">
...
<script>
    ...
    $(function () {
        ...
        timesheetsTable.on('init.dt', function () {
            ...
            $gr.removeClass('hide');
            $gr.find('div.form-check').css('position', 'absolute');
            $gr.find('div.form-check').css('top', '22px');
            $gr.find('div.form-check').css((isRTL == 'true' ? 'right' : 'left'), '-90px');
