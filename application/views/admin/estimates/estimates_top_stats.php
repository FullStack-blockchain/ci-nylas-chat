<div id="stats-top" class="hide card p-4 mb-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="progress">
                                    ...
                                    <?php echo $percent_data['percent'] == 0 ? 'no-percent-text' : ''; ?>
                                    progress-bar-<?php echo estimate_status_color_class($status); ?>" role="progressbar"
