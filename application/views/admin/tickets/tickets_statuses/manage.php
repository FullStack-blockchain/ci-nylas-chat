    ...
    <div id="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="content custom-scrollbar">
                ...
                <div id="status-manage" class="page-layout simple left-sidebar-floating">
...
<?php init_tail(); ?>
<?php echo app_script('assets-old/plugins/bootstrap-colorpicker/js', 'bootstrap-colorpicker.min.js'); ?>
<script>
    $(function () {
