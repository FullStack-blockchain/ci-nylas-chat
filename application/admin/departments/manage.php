...
<?php echo app_script('assets-old/plugins/bootstrap-colorpicker/css', 'bootstrap-colorpicker.min.css'); ?>
    ...
    <div id="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="content custom-scrollbar">
                ...
                <div id="spam-filters-manage" class="page-layout simple left-sidebar-floating">
                            ...
                            <div class="panel-body">
                                <?php if ($email_exist_as_staff) { ?>
                                    <div class="alert alert-danger">
                                        Some of the departments email is used as staff member email, according to
                                        the docs, the support department email must be unique email in the system,
                                        you must change the staff email or the support department email in order all
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-check mt-5">
                            <label class="form-check-label">
                                ...
                                <span><?php echo _l('department_hide_from_client'); ?></span>
                            </label>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check form-check-inline">
                                <label class="form-check-label">
                                    <input type="radio" class="form-check-input" name="encryption" value="tls" id="tls">
                            ...
                            <div class="form-check form-check-inline">
                                <label class="form-check-label">
                                    <input type="radio" class="form-check-input" name="encryption" value="ssl" id="ssl">
                                    <span class="radio-icon"></span>
                            ...
                            <div class="form-check form-check-inline">
                                <label class="form-check-label">
                                    <input type="radio" class="form-check-input" name="encryption" value="" id="no_enc" checked>
                                    <span class="radio-icon"></span>
                                    <span class="form-check-description"><?php echo _l('dept_email_no_encryption'); ?></span>
                                </label>
                            </div>
