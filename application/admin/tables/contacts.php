...
foreach ($rResult as $aRow) {
    ...
    $rowName = '<img src="' . contact_profile_image_url($aRow['id']) . '" class="client-profile-image-small m-r-5 avatar"><a href="#" onclick="contact(' . $aRow['userid'] . ',' . $aRow['id'] . ');return false;">' . $aRow['full_name'] . '</a>';
...
<label class="switch onoffswitch-label" for="c_' . $aRow['id'] . '">
