...
<div class="col-md-12">
    <div class="horizontal-scrollable-tabs">
        ...
        <div class="horizontal-tabs">
            <ul class="nav nav-tabs profile-tabs customer-profile-tabs nav-tabs-horizontal" role="tablist">
    ...
    <div class="tab-content">
        ...
        <?php } ?>
        <div role="tabpanel" class="fade tab-pane<?php if (!$this->input->get('tab')) {
            echo ' active in';
        }; ?>" id="contact_info">
            <div class="row">
                <div class="col-md-12<?php if (isset($client) && (!is_empty_customer_company($client->userid) && total_rows('tblcontacts', array('userid' => $client->userid, 'is_primary' => 1)) > 0)) {
                    ...
                    <div class="form-check m-b-20 m-t-0">
                        <label class="form-check-label">
                            <input type="checkbox"
                                   class="form-check-input" <?php if (isset($client) && $client->show_primary_contact == 1) {
                                echo ' checked';
                            } ?> value="1" id="show_primary_contact" name="show_primary_contact"/>
                            <span class="checkbox-icon"></span>
                            <span><?php echo _l('show_primary_contact', _l('invoices') . ', ' . _l('estimates') . ', ' . _l('payments') . ', ' . _l('credit_notes')); ?></span>
                        </label>
                    </div>
                </div>
                <div class="col-md-6 mb-5">
                    ...
                    $currencyLabel = 'invoice_add_edit_currency';
                    if (!isset($client)) {
                        $currencyLabel = '<label for="default_currency" class="control-label"><i class="fa fa-question-circle" data-toggle="tooltip"
                           data-title="' . _l('customer_currency_change_notice') . '"></i>' . _l('invoice_add_edit_currency', '', false) . '</label>';
                    }
                    echo render_select('default_currency', $currencies, array('id', 'name', 'symbol'),
                        $currencyLabel, $selected, $s_attrs); ?>
        ...
        <?php if (isset($client)) { ?>
            <div role="tabpanel" class="fade tab-pane" id="customer_admins">
        ...
        <?php } ?>
        <div role="tabpanel" class="fade tab-pane" id="billing_and_shipping">
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-6 mb-5">
                            <h4 class="f-18"><?php echo _l('billing_address'); ?> <a href="#"
                                                                                     class="pull-right billing-same-as-customer">
                                    <small class="f-13"><?php echo _l('customer_billing_same_as_profile'); ?></small>
                                </a></h4>
                            <hr/>
                        ...
                        <div class="col-md-6 mb-5">
                            <h4 class="f-18">
                                ...
                                <?php echo _l('shipping_address'); ?> <a href="#"
                                    ...
                                    <small class="f-13"><?php echo _l('customer_billing_copy'); ?></small>
                                </a>
                            </h4>
                            <hr/>
                            ...
                            <div class="col-md-12">
                                <div class="alert alert-warning">
                                    <div class="form-check mt-4 mb-4">
                                        <label class="form-check-label">
                                            <input type="checkbox" name="update_all_other_transactions" class="form-check-input"
                                                   id="update_all_other_transactions">
                                            <span class="checkbox-icon"></span>
                                            <span><?php echo _l('customer_update_address_info_on_invoices'); ?></span>
                                        </label>
                                    </div>
                                    ...
                                    <div class="form-check mt-4">
                                        <label class="form-check-label">
                                            <input type="checkbox" name="update_credit_notes" id="update_credit_notes" class="form-check-input">
                                            <span class="checkbox-icon"></span>
                                            <span><?php echo _l('customer_profile_update_credit_notes'); ?></span>
                                        </label>
                                    </div>
