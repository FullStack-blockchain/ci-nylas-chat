...
<div class="p-4">
    <button class="btn btn-info mb-4" data-toggle="modal" data-target="#entryModal"><i class="fa fa-lock s-4" aria-hidden="true"></i> <?php echo _l('new_vault_entry'); ?>
    </button>
        ...
        <div class="panel panel-default panel-vault">
            <div class="panel-heading" role="tab" id="<?php echo 'vaultEntryHeading-' . $entry['id']; ?>">
                ...
                <?php if ($entry['creator'] == get_staff_user_id() || is_admin()) { ?>
                    ...
                    <a href="#" onclick="edit_vault_entry(<?php echo $entry['id']; ?>); return false;"
                       class="pull-right text-muted"><i class="fa fa-pencil-square-o mright10"></i></a>
                <?php } ?>
                            ...
                            <?php if (!empty($entry['description'])) { ?>
                                <p>
                                    <b><?php echo _l('vault_description'); ?>
                                        : </b><br/><?php echo $entry['description']; ?>
                                </p>
                                <hr/>
                            <?php } ?>
            ...
            <div class="modal-content full-height">
                ...
                <div class="modal-body no-padding-top">
                    ...
                    <input type="password" class="fake-autofill-field" name="fakepasswordremembered" value=''
                           tabindex="-1"/>
                    <?php echo render_input('server_address', 'server_address','','text',[],[],'no-padding'); ?>
                    ...
                    <hr class="mt-4 mb-4"/>
                    <div class="form-check f-14 mb-1">
                        <label class="form-check-label">
                            <input type="radio" class="form-check-input" name="visibility" value="1" id="only_creator_visible_all" checked>
                            <span class="radio-icon"></span>
                            <span for="only_creator_visible_all"><?php echo _l('vault_entry_visible_to_all'); ?></span>
                        </label>
                    </div>
                    <div class="form-check f-14 mb-1">
                        <label class="form-check-label">
                            <input type="radio" class="form-check-input" name="visibility" value="2" id="only_creator_visible_administrators">
                            <span class="radio-icon"></span>
                            <span for="only_creator_visible_me"><?php echo _l('vault_entry_visible_creator'); ?></span>
                        </label>
                    </div>
                    <div class="form-check f-14 mb-1">
                        <label class="form-check-label">
                            <input type="radio" class="form-check-input" name="visibility" value="3" id="only_creator_visible_me">
                            <span class="radio-icon"></span>
                            <span for="share_in_projects"><?php echo _l('vault_entry_share_on_projects'); ?></span>
                        </label>
                    </div>
                    <hr class="mt-4 mb-4"/>
                    <div class="form-check f-14 mb-1">
                        <label class="form-check-label">
                            <input type="checkbox" class="form-check-input" id="share_in_projects" name="share_in_projects"/>
