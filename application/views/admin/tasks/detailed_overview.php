    ...
    <div id="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="content custom-scrollbar">
                ...
                <div id="tasks-detail-overview" class="page-layout simple left-sidebar-floating">
                                    ...
                                    <div class="col-md-12">
                                        <?php if (!$this->input->get('project_id')) { ?>
                                            <a href="<?php echo admin_url('tasks'); ?>"
                                               class="btn btn-secondary pull-left"><?php echo _l('back_to_tasks_list'); ?></a>
                                        <?php } else { ?>
                                            <a href="<?php echo admin_url('projects/view/' . $this->input->get('project_id') . '?group=project_tasks'); ?>"
                                               class="pull-left btn btn-secondary"><?php echo _l('back_to_project'); ?></a>
                                        <?php } ?>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2 text-center">
                                                <div class="form-group no-margin select-placeholder">
                                                    <select name="status" id="status"
                                                        ...
                                                        <option value=""
                                                                selected><?php echo _l('task_list_all'); ?></option>
                                            ...
                                            <div class="col-md-2 select-placeholder">
                                                <div class="form-group no-margin select-placeholder">
                                        ...
                                        <?php foreach ($overview as $month => $data) {
                                            ...
                                            <table class="table tasks-overview dt-table scroll-responsive">
                                                ...
                                                foreach ($data as $task) { ?>
                                                    <tr>
                                                        <td data-order="<?php echo htmlentities($task['name']); ?>">
                                                            <a
