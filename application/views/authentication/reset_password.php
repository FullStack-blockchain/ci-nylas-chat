...
<body class="layout layout-vertical reset-password">
<main>
    <div id="wrapper">
                ...
                <div id="login" class="p-8">
                    ...
                    <div class="form-wrapper md-elevation-8 p-8">
                        <div class="title mt-4 mb-8 text-uppercase"
                             style="font-size: 24px"><?php echo _l('admin_auth_reset_password_heading'); ?></div>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <label for="password"><?php echo _l('admin_auth_reset_password'); ?></label>
                        </div>

                        <div class="form-group mb-4">
                            <input type="passwordr" class="form-control" name="passwordr" id="passwordr"
                                   placeholder=" "/>
                            <label for="passwordr"><?php echo _l('admin_auth_reset_password_repeat'); ?></label>
                        </div>
