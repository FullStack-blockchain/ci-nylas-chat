    ...
    <div class="col-sm-12">
        <div class="box box-default box-solid">
            <div class="box-header with-border">
                <i class="fa fa-list-alt"></i> <?php echo $encodeExplorer->getString("lists"); ?>
            ...
            <div class="box-body">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="row">
                            <div class="col-sm-12">
                                <label><?php print $encodeExplorer->getString("default_view"); ?></label>
                            </div>
                        </div>
                        <label class="radio-inline clear">
                            ...
                            <?php echo $encodeExplorer->getString("grid"); ?>
                        </label>
                        ...
                        <label class="radio-inline">
                            ...
                            <?php echo $encodeExplorer->getString("list"); ?>
                        </label>
                        ...
                        <div class="form-group">
                            <div class="checkbox checkbox-big">
                                <label>
                                    ...
                                    <?php echo $encodeExplorer->getString("inline_thumbs"); ?>
                                </label>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-12">
                                <div class="checkbox checkbox-big">
                                    <label>
                                        ...
                                        <?php echo $encodeExplorer->getString("can_thumb"); ?>
                                    </label>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-12">
                                <div class="row">
                                    <div class="form-group col-xs-6">
                                        <label><?php print $encodeExplorer->getString("max_width"); ?></label>
                                    ...
                                    <div class="form-group col-xs-6">
                                        <label><?php print $encodeExplorer->getString("max_height"); ?></label>
                                        <div class="input-group">
                            ...
                            <div class="col-sm-12">
                                <div class="checkbox checkbox-big">
                                    <label>
                                        ...
                                        <?php echo $encodeExplorer->getString("show_search"); ?>
                                    </label>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-12">
                                <div class="checkbox checkbox-big">
                                    <label>
                                        ...
                                        <?php echo $encodeExplorer->getString("mp3_player"); ?>
                                    </label>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-12">
                                <div class="checkbox checkbox-big">
                                    <label>
                                        ...
                                        <?php echo $encodeExplorer->getString("video_player"); ?>
                                    </label>
                                </div>
                            </div>
                        </div>
...
<h4><i class="fa fa-files-o"></i> <?php echo $encodeExplorer->getString("files"); ?></h4>
                            ...
                            <div class="col-sm-12">
                                <div class="checkbox checkbox-big">
                                    <label>
                                        ...
                                        <?php echo $encodeExplorer->getString("show_pagination"); ?>
                                    </label>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group">
                                    <div class="checkbox clear checkbox-big">
                                        <label>
                                            ...
                                            <?php echo $encodeExplorer->getString("show_pagination_num"); ?>
                                        </label>
                                    </div>
                                </div>
                                <div class="form-group">
...
<h4><i class="fa fa-folder-o"></i> <?php echo $encodeExplorer->getString("folders"); ?></h4>
                            ...
                            <div class="col-sm-12">
                                <div class="checkbox checkbox-big">
                                    <label>
                                        ...
                                        <?php echo $encodeExplorer->getString("show_pagination_folders"); ?>
                                    </label>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-12">
                                <div class="checkbox clear checkbox-big">
                                    <label>
                                        ...
                                        <?php echo $encodeExplorer->getString("counter"); ?>
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="checkbox checkbox-big form-group">
                            <label>
                                ...
                                <?php echo $encodeExplorer->getString("folders_download"); ?>
                            </label>
                        </div>
