<div class="modal fade modal-reminder reminder-modal-<?php echo $name; ?>-<?php echo $id; ?>" tabindex="-1"
     role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title full-width" id="myModalLabel">
                    <?php echo $reminder_title; ?><i class="fa fa-question-circle text-white" data-toggle="tooltip" title="<?php echo _l('set_reminder_tooltip'); ?>"data-placement="bottom"></i>
                    <button type="button" class="close close-reminder-modal pull-right" data-rel-id="<?php echo $id; ?>"
                            data-rel-type="<?php echo $name; ?>" aria-label="Close"><span aria-hidden="true">&times;</span>
                    </button>
                </h4>
            </div>
                            ...
                            <div class="form-group">
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="checkbox" class="form-check-input" name="notify_by_email" id="notify_by_email"/>
                                        <span class="checkbox-icon"></span>
                                        <span for="notify_by_email"><?php echo _l('reminder_notify_me_by_email'); ?></span>
                                    </label>
                                </div>
                            </div>
                        <?php } ?>
