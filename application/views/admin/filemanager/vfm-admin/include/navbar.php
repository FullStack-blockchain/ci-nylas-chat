            ...
            <div class="tab-content">
              ...
              <div role="tabpanel" class="tab-pane fade in active" id="upprof">
                  <div class="form-group">
                    ...
                    class="form-control" value="<?php echo $gateKeeper->getUserInfo('name'); ?>">
                    ...
                    <label for="user_new_pass">
                        <?php echo $encodeExplorer->getString("new_password"); ?>
                    </label>
                    <div class="input-group">
                    ...
                    <label for="user_old_pass">
                        * <?php echo $encodeExplorer->getString("current_pass"); ?>
                    </label> 
                    <div class="input-group">
            ...
            if (isset($customfield['type'])) { ?>
                <div class="form-group">
                    ...
                    if ($customfield['type'] === 'textarea') { ?>
                        <textarea name="<?php echo $customkey; ?>" 
                            class="form-control getuser getuser-<?php echo $customkey; ?>" 
                            rows="2"><?php echo $optionselecta; ?></textarea>
                    <?php
                    }
                    if ($customfield['type'] === 'select' && is_array($customfield['options'])) {
                        ...
                        foreach ($customfield['options'] as $optionval => $optiontitle) { ?>
                            ...
                            <?php if ($optionselecta == $optionval) {
                                echo 'selected';
                    ...
                    if ($customfield['type'] === 'text' || $customfield['type'] === 'email') { ?>
                        <input type="<?php echo $customfield['type']; ?>" 
                        name="<?php echo $customkey; ?>" 
                        class="form-control" 
                        value="<?php echo $optionselecta; ?>">
                    <?php
                    } ?>
                </div>
                <?php
