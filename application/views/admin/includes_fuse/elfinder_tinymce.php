...
<head>
    ...
    <script src="<?php echo base_url('assets-old/plugins/jquery-ui/jquery-ui.min.js'); ?>"></script>
    <!-- elFinder JS (REQUIRED) -->
    <script src="<?php echo base_url('assets-old/plugins/elFinder/js/elfinder.min.js'); ?>"></script>
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets-old/plugins/elFinder/themes/Material/css/theme-gray.css'); ?>">
    <?php echo app_stylesheet('assets-old/css','style.css');
    $lng = get_media_locale($locale);
    if(file_exists(FCPATH.'assets-old/plugins/elFinder/js/i18n/elfinder.'.$lng.'.js') && $lng != 'en'){ ?>
        <script src="<?php echo base_url('assets-old/plugins/elFinder/js/i18n/elfinder.'.$lng.'.js'); ?>"></script>
    <?php } ?>
         ...
         start = function(elFinder, editors, config) {
             ...
             $(function() {
                 ...
                 var optEditors = {
                     ...
                     opts = {
                         height: 700,
                         cssAutoLoad: [site_url + 'assets-old/plugins/elFinder/themes/Material/css/theme-gray.css'],
