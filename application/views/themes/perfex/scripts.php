...
<?php } ?>
<script src="<?php echo base_url('assets-old/plugins/bootstrap/js/bootstrap.min.js'); ?>"></script>
<script src="<?php echo base_url('assets-old/plugins/datatables/datatables.min.js'); ?>"></script>
<?php app_jquery_validation_plugin_js($locale); ?>
<?php app_select_plugin_js($locale); ?>
<script src="<?php echo base_url('assets-old/plugins/datetimepicker/jquery.datetimepicker.full.min.js'); ?>"></script>
<script src="<?php echo base_url('assets-old/plugins/Chart.js/Chart.min.js'); ?>" type="text/javascript"></script>
<script src="<?php echo base_url('assets-old/plugins/bootstrap-colorpicker/js/bootstrap-colorpicker.min.js'); ?>"></script>
<?php echo app_script(template_assets_path().'/js','global.js'); ?>
<script src="<?php echo base_url('assets-old/plugins/lightbox/js/lightbox.min.js'); ?>"></script>
<?php if(is_client_logged_in()){ ?>
<script src="<?php echo base_url('assets-old/plugins/dropzone/min/dropzone.min.js'); ?>"></script>
...
<?php } ?>
<script src="<?php echo base_url('assets-old/plugins/fullcalendar/fullcalendar.min.js'); ?>"></script>
<?php if(file_exists(FCPATH.'assets-old/plugins/fullcalendar/locale/'.$locale.'.js')){ ?>
