    ...
    <div id="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="content">
                ...
                <div id="manage_expenses_reports" class="page-layout simple left-sidebar-floating">
                                ...
                                <div class="card mb-3">
                                    <div class="card-body">
                                        <div class="pull-right">
                                            <a href="<?php echo admin_url('reports/expenses/detailed_report'); ?>"
                                               class="btn btn-success"><?php echo _l('expenses_detailed_report'); ?></a>
                                        </div>
                                        <?php if ($export_not_supported) { ?>
                                            <p class="text-danger">Exporting not support in IE. To export this data
                                                please try another browser</p>
                                        <?php } ?>
                                        <a href="#" onclick="make_expense_pdf_export(); return false;" style="min-width: auto"
                                           class="btn btn-info pull-left mr-4<?php if ($export_not_supported) {
                                               echo ' disabled';
                                           } ?>"><i class="fa fa-file-pdf-o line-height-25"></i></a>
                                        <a download="expenses-report-<?php echo $current_year; ?>.xls" style="min-width: auto"
                                           class="btn btn-info pull-left mr-4<?php if ($export_not_supported) {
                                               echo ' disabled';
                                           } ?>" href="#"
                                           onclick="return ExcellentExport.excel(this, 'expenses-report-table', 'Expenses Report <?php echo $current_year; ?>');"><i
                                                    class="fa fa-file-excel-o line-height-25"></i></a>
                                        ...
                                        if (is_using_multiple_currencies('tblexpenses')) { ?>
                                            <div data-toggle="tooltip" class="pull-left mright5"
                                    ...
                                    <div class="card-body">
                                        <div class="form-check mt-4 mb-4">
                                            <label class="form-check-label">
                                                <input type="checkbox" name="exclude_billable" onchange="filter_expenses();" class="form-check-input"
                                                       id="exclude_billable" <?php if ($this->input->get('exclude_billable')) {
                                                    echo 'checked';
                                                }; ?>>
                                                <span class="checkbox-icon"></span>
                                                <span><?php echo _l('expenses_report_exclude_billable'); ?></span>
                                            </label>
                                        </div>
                                        <div class="table-responsive mb-4">
                                            <table class="table table-bordered table-hover expenses-report"
                                                ...
                                                <tr>
                                                    ...
                                                    ?>
                                                    <th class="bold"> <?php echo _l('year'); ?>
...
<?php init_tail(); ?>
<script src="<?php echo base_url('assets-old/plugins/excellentexport/excellentexport.min.js'); ?>"></script>
<script>
