    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content full-height">
            <div class="modal-header">
                <h4 class="modal-title"><?php echo _l('invoice_bill_to').' / '._l('shipping_address'); ?></h4>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <hr class="mt-4 mb-4"/>
                        <a href="#" class="pull-right" id="get_shipping_from_customer_profile" data-placement="left"
                           data-toggle="tooltip" title="<?php echo _l('get_shipping_from_customer_profile'); ?>"><i
                                    class="fa fa-user"></i></a>
                        <div class="clearfix"></div>
                        <div class="form-group">
                            <div class="form-check checkbox-inline">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" id="include_shipping"
                                           name="include_shipping" <?php if (isset($estimate) && $estimate->include_shipping == 1) {
                                        echo 'checked';
                                    } ?>/>
                                    <span class="checkbox-icon"></span>
                                    <span for="include_shipping"><?php echo _l('shipping_address'); ?></span>
                                </label>
                            </div>
                        </div>
                        <div id="shipping_details"
                             class="<?php if ((isset($estimate) && $estimate->include_shipping != 1) || !isset($estimate)) {
                                 echo 'hide';
                             } ?>">
                            <div class="form-group">
                                <div class="form-check checkbox-inline">
                                    <label class="form-check-label">
                                        <input type="checkbox" class="form-check-input" id="show_shipping_on_estimate"
                                               name="show_shipping_on_estimate" <?php if ((isset($estimate) && $estimate->show_shipping_on_estimate == 1) || !isset($estimate)) {
                                            echo 'checked';
                                        } ?>/>
                                        <span class="checkbox-icon"></span>
                                        <span for="show_shipping_on_estimate"><?php echo _l('show_shipping_on_estimate'); ?></span>
                                    </label>
                                </div>
                            </div>
