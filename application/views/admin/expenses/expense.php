...
<link type="text/css" rel="stylesheet" href="<?php echo base_url('assets/css/expense.css'); ?>">
<main>
    <div id="wrapper">
        <?php init_aside(); ?>
        ...
        <div class="content-wrapper">
            ...
            <div class="content custom-scrollbar">
                ...
                <div id="expense-manage" class="page-layout simple left-sidebar-floating">

                    <div class="page-header bg-primary text-auto row no-gutters align-items-center justify-content-between p-4">
                        <div class="col col-md mb-3">
                            <span class="logo-text h4"><?php if (!isset($expense)) echo _l('add_new'); else echo _l('edit');
                                echo " " . _l('expense'); ?></span>
                        </div>
                        ...
                        <div class="content">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="card">
                                        <div class="panel-body">
                                            ...
                                            ?>
                                            <h4 class="no-margin f-18"><?php echo $title; ?></h4>
                                            <hr class="hr-panel-heading"/>
                                            <?php if (isset($expense) && $expense->attachment !== '') { ?>
                                                <div class="row">
                                                    <div class="col-md-10">
                                                        <i class="<?php echo get_mime_class($expense->filetype); ?>"></i>
                                                        <a href="<?php echo site_url('download/file/expense/' . $expense->expenseid); ?>"><?php echo $expense->attachment; ?></a>
                                                    </div>
                                            ...
                                            $label = '<label for="expense_name">' . _l('expense_name') . '</label>
                                                <i class="fa fa-question-circle s-4" data-toggle="tooltip" data-title="' . _l('expense_name_help') . ' - ' . _l('expense_field_billable_help', _l('expense_name')) . '"></i>';
                                            echo render_input('expense_name', $label, $value); ?>
                                            <?php $value = (isset($expense) ? $expense->note : '');
                                            $label = '<label for="note">' . _l('expense_add_edit_note') . '</label>
                                                <i class="fa fa-question-circle s-4" data-toggle="tooltip" data-title="' . _l('expense_field_billable_help', _l('expense_add_edit_note')) . '"></i>';
                                            echo render_textarea('note', $label, $value, array('rows' => 4), array()); ?>
                                            <?php
                                            ...
                                            <div class="checkbox checkbox-primary billable <?php echo $hide_billable_options; ?>">
                                                <input type="checkbox"
                                                       id="billable" <?php if (isset($expense) && $expense->invoiceid !== NULL) {
                                                    echo 'disabled';
                                ...
                                <div class="col-md-6">
                                    <div class="card">
                                        <div class="panel-body">
                                            <h4 class="no-margin f-18"><?php echo _l('advanced_options'); ?></h4>
                                            <hr class="hr-panel-heading"/>
                                            <?php
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group select-placeholder">
                                                        <label class="control-label"
                                                               for="tax"><?php echo _l('tax_1'); ?></label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group select-placeholder">
                                                        <label class="control-label"
                                                               for="tax2"><?php echo _l('tax_2'); ?></label>
                                                        <select class="selectpicker display-block" data-width="100%"
                                                                name="tax2"
                                            ...
                                            <div class="form-group select-placeholder">
                                                ...
                                                <select name="repeat_every" id="repeat_every" class="selectpicker"
                                                        data-width="100%"
                                                        data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                                                    <option value=""></option>
                                            ...
                                            <div id="cycles_wrapper"
                                                 class="<?php if (!isset($expense) || (isset($expense) && $expense->recurring == 0)) {
                                                     echo ' hide';
                                                 } ?>">
                                                ...
                                                <div class="form-group recurring-cycles">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="number"
                                                               class="form-control"<?php if ($value == 0) {
                                                            echo ' disabled';
                                                        } ?> name="cycles" id="cycles"
                                                               value="<?php echo $value; ?>" <?php if (isset($expense) && $expense->total_cycles > 0) {
                                            ...
                                            <div>
                                                ...
                                                <div class="checkbox checkbox-primary billable_recurring_options <?php echo $hide_invoice_recurring_options; ?>">
                                                    <input type="checkbox" id="create_invoice_billable"
                                                           name="create_invoice_billable" <?php if (isset($expense)) {
                                                        if ($expense->create_invoice_billable == 1) {
                                                            echo 'checked';
                                                        }
                                                    }; ?>>
                                                    <label for="create_invoice_billable"><i
                                                                class="fa fa-question-circle" data-toggle="tooltip"
                                                                title="<?php echo _l('expense_recurring_autocreate_invoice_tooltip'); ?>"></i> <?php echo _l('expense_recurring_auto_create_invoice'); ?>
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="checkbox checkbox-primary billable_recurring_options <?php echo $hide_invoice_recurring_options; ?>">
                                                <input type="checkbox" name="send_invoice_to_customer"
                                                       id="send_invoice_to_customer" <?php if (isset($expense)) {
                                ...
                                <div class="expense-form-save-buttons">
                                    <button type="submit"
