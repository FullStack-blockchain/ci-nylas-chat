    ...
    <div class="col-md-6">
        <div class="form-group pt-0">
            ...
            <div class="select-placeholder">
                <select name="settings[gdpr_contact_data_portability_allowed][]" data-actions-box="true" multiple
                        title="None" id="gdpr_contact_data_portability_allowed" class="selectpicker" data-width="100%">
                    ...
                    <optgroup label="Projects">
                        ...
                        <option value="related_tasks"<?php if (in_array('related_tasks', $valAllowed)) {
                            echo ' selected';
                        } ?>>Tasks created from contact and tasks where contact commented
                        </option>
                        <option value="related_discussions"<?php if (in_array('related_discussions', $valAllowed)) {
                            echo ' selected';
                        } ?>>Discussions created from contact and discussions where contact commented
                        </option>
...
<div class="row">
    <div class="col-md-6">
        <div class="form-group pt-0">
            ...
            <div class="select-placeholder">
                <select name="settings[gdpr_lead_data_portability_allowed][]" data-actions-box="true" multiple
                        title="None" id="gdpr_lead_data_portability_allowed" class="selectpicker" data-width="100%">
                    <option value=""></option>
                    <option value="profile_data"<?php if (in_array('profile_data', $valAllowed)) {
                        echo ' selected';
                    } ?>>Profile Data
