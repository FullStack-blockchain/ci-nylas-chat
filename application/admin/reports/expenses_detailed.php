    ...
    <div id="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="content">
                ...
                <div id="manage_details_expenses_reports" class="page-layout simple left-sidebar-floating">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <a href="<?php echo admin_url('reports/expenses'); ?>"
                                           class="btn btn-default pull-left" style="min-width: auto !important;"><?php echo _l('go_back'); ?></a>
