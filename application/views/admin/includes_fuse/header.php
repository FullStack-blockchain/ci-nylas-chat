    ...
    <div class="row no-gutters align-items-center flex-nowrap">
        ...
        <div class="col-auto m-hidden-search">
            ...
            <div class="row no-gutters align-items-center justify-content-end">                
                ...
                <div class="timer-dropdown top-timers" data-toggle="tooltip" title="<?php echo _l('nav_todo_items'); ?>"
                     data-placement="bottom" id="top-timers">
                ...
                <div class="notifications-dropdown notification-wrapper pull-right" data-toggle="tooltip" title="<?php echo _l('nav_notifications'); ?>" data-placement="bottom">
                    <button href="#" class="dropdown-toggle header-icon-button btn btn-icon" data-toggle="dropdown">
