...
<h4 class="bold chk-heading th f-15"><?php echo _l('task_checklist_items'); ?></h4>
<?php } ?>
...
<div>
    ...
    <div class="checkbox checkbox-success checklist-checkbox" data-toggle="tooltip" title="">
        ...
        <div class="form-check">
            <label class="form-check-label">
                <input type="checkbox" class="form-check-input" <?php if($list['finished'] == 1 && $list['finished_from'] != get_staff_user_id() && !is_admin()){echo 'disabled';} ?> name="checklist-box" <?php if($list['finished'] == 1){echo 'checked';}; ?> />
    ...
    <p class="font-medium-xs text-muted checklist-item-completed-by">
        <?php
