                    ...
                    <div class="page-content p-4 p-sm-6">
                        <?php if ($fixedlist == false) { ?>
                            <?php if (has_permission('surveys', '', 'create')) { ?>
                                <div class="card mb-4">
                                    <div class="card-body">
                                        <a href="#" class="btn btn-secondary pull-left mr-5"
                                           data-toggle="modal"
                                            ...
                                            <div class="col-md-6 mtop10">
                                                ...
                                                <div class="radio radio-inline radio-info">
                                                    <input type="radio" name="active_customers_filter"
                                                           id="active_customers" value="active_customers">
                                                    <label for="active_customers"><?php echo _l('active_customers'); ?></label>
                                                </div>
                                                <div class="radio radio-inline radio-info">
                                                    <input type="radio" name="active_customers_filter"
                                                           id="active_contacts" value="active_contacts">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <?php
                            if (count($custom_fields) > 0) { ?>
                                <p class="mt-4 bold"><?php echo _l('mail_list_available_custom_fields'); ?></p>
