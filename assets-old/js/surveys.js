...
function add_survey_question(type, surveyid) {
    $.post(admin_url + 'surveys/add_survey_question', {
        ...
        question_area += '<label class="form-check-label required">';
        question_area += '<input type="checkbox" class="form-check-input" data-question_required="' + response.data.questionid + '" name="required[]" onchange="update_question(this,\'' + type + '\',' + response.data.questionid + ')" class="survey_input_box_description full-width">';
        question_area += '<span class="checkbox-icon"></span>';
        question_area += '<span>'+ response.survey_question_required +'</span>';
        question_area += '</label>';
        question_area += '</div>';
        ...
        if (type == 'textarea') {
            ...
            question_area += '<input type="' + type + '" class="form-check-input">';
            question_area += '<span class="' + type + '-icon"></span>';
            question_area += '<span class="full-width"><input class="form-control" onblur="update_question(this,\'' + type + '\',' + response.data.questionid + ');" type="text" data-box-descriptionid="' + response.data[0].questionboxdescriptionid + '" class="survey_input_box_description full-width"></span>';
            question_area += '</label>';
            question_area += '</div>';
