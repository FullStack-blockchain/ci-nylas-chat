    ...
    <div id="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="content custom-scrollbar">
                ...
                <div id="import-customers" class="page-layout simple left-sidebar-floating">
                    ...
                    <div class="page-header bg-primary text-auto row no-gutters align-items-center justify-content-between p-4">
                        <div class="col col-md mb-3">
                            ...
                            <span class="logo-text h4"><?php echo _l('import_customers'); ?></span>
                        </div>
                        <div class="col-auto ml-4">
                            <?php echo form_open($this->uri->uri_string()); ?>
                            <?php echo form_hidden('download_sample', 'true'); ?>
                            <button type="submit" class="btn btn-success text-white">Download Sample</button>
                            <?php echo form_close(); ?>
                        </div>
                    </div>
                    <!-- / HEADER -->
                                    ...
                                    <div class="panel-body">
                                        ...
                                        if (($max_input > 0 && isset($total_rows_post) && $total_rows_post >= $max_input)) { ?>
                                            <div class="alert alert-warning">
                                                Your hosting provider has PHP setting <b>max_input_vars</b>
                                                at <?php echo $max_input; ?>.<br/>
                                                Ask your hosting provider to increase the <b>max_input_vars</b> setting
                                                to <?php echo $total_rows_post; ?> or higher or import less rows.
                                            </div>
                                        <?php } ?>
                                        <?php if (!isset($simulate)) { ?>
                                            <ul>
                                                <li>1. Your CSV data should be in the format below. The first line of
                                                    your CSV file should be the column headers as in the table example.
                                                    Also make sure that your file is <b>UTF-8</b> to avoid unnecessary
                                                    <b>encoding problems</b>.
                                                </li>
                                                <li>2. If the column <b>you are trying to import is date</b> make sure
                                                    that is formatted in format Y-m-d (<?php echo date('Y-m-d'); ?>).
                                                </li>
                                                <li>3. Make sure you configure the default contact permission in
                                                    Setup->Settings->Customers to get the best results like auto
                                                ...
                                                <table class="table table-hover table-bordered">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php foreach ($client_contacts_fields as $field) {
                                                            ...
                                                            ?>
                                                            <?php $total_fields++; ?>
                                                            <th class="bold"><?php if ($field == 'firstname' || $field == 'lastname' || $field == 'email') {
                                                                ...
                                                                ?>
                                                                <span class="text-secondary"><?php echo _l('import_contact_field'); ?></span>
                                                            </th>
                                                        <?php } ?>
                                                        <?php foreach ($client_db_fields as $field) {
                                                            ...
                                                            ?>
                                                            <?php $total_fields++; ?>
                                                            <th class="bold"> <?php if ($field == 'company' && get_option('company_is_required') == 1) {
                                                                    echo '<span class="text-danger">* </span>';
                                                                } ?><?php echo str_replace('_', ' ', ucfirst($field)); ?></th>
                                                        <?php } ?>
                                        ...
                                        <?php } ?>
                                        <?php if (isset($simulate)) { ?>
                                            <h4 class="bold">Simulation Data
                                                <small class="text-secondary">Max 100 rows are shown</small>
                                            </h4>
                                            <p class="text-secondary">If you are satisfied with the results upload the file
                                                again and click import</p>
                                            <div class="table-responsive no-dt">
                                                <table class="table table-hover table-bordered">
                                                    <thead>
                                                    <tr>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 mtop15">
                                                ...
                                                <div class="form-group">
                                                    <button type="button"
                                                            class="btn btn-secondary import btn-import-submit"><?php echo _l('import'); ?></button>
                                                    <button type="button"
                                                            class="btn btn-secondary simulate btn-import-submit"><?php echo _l('simulate_import'); ?></button>
                                                </div>
                                                <?php echo form_close(); ?>
                                            </div>
                                        </div>
...
<?php init_tail(); ?>
<script src="<?php echo base_url('assets-old/plugins/jquery-validation/additional-methods.min.js'); ?>"></script>
<script>
    $(function () {
        _validate_form($('#import_form'), {
