...
* VFM call uploaders
*/
function notifyusers(){var e=location.pathname,n=location.search;n=n.replace("&response",""),n=n.replace("?response",""),n=n.replace("?del","?nodel"),n=n.replace("&del","&nodel"),""==n?n="?":n+="&";var o=$("#userslist :checkbox:checked").length>0;if(1==o){var t=$.now(),r=$("#userslist").serialize();$.ajax({cache:!1,type:"POST",url:"vfm-admin/ajax/sendupnotif.php?t="+t,data:r}).done(function(o){setTimeout(function(){location.href=e+n+"response"},800)})}else setTimeout(function(){location.href=e+n+"response"},800)}function resumableJsSetup(e,n,o,t){e=e||"no",t=t||!1;var r=(navigator.userAgent.toLowerCase(),e),i=new Resumable({target:"vfm-admin/chunk.php?loc="+n,simultaneousUploads:3,prioritizeFirstAndLastChunk:!0,minFileSizeErrorCallback:function(e,n){setTimeout(function(){alert(e.fileName||e.name+" is not valid.")},1e3)}}),a=0,u=0;if(i.support&&"no"==r)i.assignBrowse(document.getElementById("upchunk")),i.assignDrop(document.getElementById("uparea")),$("#fileToUpload").attr("placeholder",o),i.on("uploadStart",function(){$("#resumer").remove(),$("#upchunk").before('<button class="btn btn-primary" id="resumer"><i class="fa fa-pause"></i></button>'),window.onbeforeunload=function(){return"Are you sure you want to leave?"},$("#resumer").on("click",function(){i.pause()})}),i.on("pause",function(){$("#resumer").remove(),$("#upchunk").before('<button class="btn btn-primary" id="resumer"><i class="fa fa-play"></i></button>'),$("#resumer").on("click",function(){i.upload()})}),i.on("progress",function(){a=100*i.progress(),u=a.toFixed(1),$(".upbar p").html(u+"%"),$(".upbar").width(a+"%")}),1==t&&i.on("fileProgress",function(e){a=100*e.progress(!0),$(".upbarfile p").html(e.fileName),$(".upbarfile").width(a+"%")}),i.on("error",function(e,n){console.log(e,n)}),i.on("fileAdded",function(e,n){i.upload()}),i.on("fileSuccess",function(e,n){var o='<input type="hidden" name="filename[]" value="'+e.fileName+'">';$("#userslist").append(o)}),i.on("complete",function(){window.onbeforeunload=null,notifyusers()}),$("#uparea").on("dragstart dragenter dragover",function(e){$(".overdrag").css("display","block")}),$(".overdrag").on("drop dragleave dragend mouseup",function(e){$(".overdrag").css("display","none")});else{var s=document.all?!0:!1;$("#upchunk").remove(),$("#upformsubmit").prop("disabled",!0).show(),s||"Windows"===$.client.os&&"Safari"===$.client.browser||"yes"===r?($("#upload_file").css("display","table-cell"),$(".ie_hidden").remove(),$(document).on("click","#upformsubmit",function(e){$("#fileToUpload").val("Loading....")})):($(document).on("click","#fileToUpload",function(){$(".upload_file").trigger("click")}),$(document).on("click","#upformsubmit",function(e){e.preventDefault(),$(".upload_file").trigger("click")})),$(document).ready(function(){var e=$("#progress-up"),n=$(".upbar"),o=$(".upbar p");$("#upForm").ajaxForm({beforeSend:function(){e.css("opacity",1)},uploadProgress:function(e,t,r,i){var a=i,u=i.toFixed(1);n.width(a),o.html(u)},success:function(){var e="100";n.width(e+"%"),o.html(e+"%")},complete:function(e){notifyusers()}})}),$(".btn-file :file").on("fileselect",function(e,n,o){for(var t=$(this).parents(".input-group").find(":text"),r=n>1?n+" files selected":o,i=$(this)[0].files,a=0;a<i.length;a++){var u='<input type="hidden" name="filename[]" value="'+i[a].name+'">';$("#userslist").append(u)}t.length&&(t.val(r),s?$("#upformsubmit").prop("disabled",!1):$("#upForm").submit())})}}