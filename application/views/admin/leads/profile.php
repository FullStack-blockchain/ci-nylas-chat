<div class="<?php if ($openEdit == true) {
    ...
    <?php if (isset($lead)) { ?>
        ...
        <a href="#" lead-edit
           class="btn btn-outline-secondary mright10 mr-2  font-medium-xs pull-left<?php if ($lead_locked == true) {
               echo ' hide';
           } ?>" style="min-height: 3rem !important;">
            <?php echo _l('edit'); ?>
            <i class="fa fa-pencil-square-o line-height-25"></i>
        </a>
        <div class="btn-group pull-left lead-actions-left">
            <a href="#" class="btn btn-outline-primary font-medium-xs dropdown-toggle" data-toggle="dropdown"
               aria-haspopup="true"
               aria-expanded="false" id="lead-more-btn" style="min-height: 3rem !important;">
                <?php echo _l('more'); ?>
        ...
        <div class="btn-group pull-right">
            <a data-toggle="tooltip" class="btn btn-default lead-print-btn lead-top-btn lead-view mleft5"
               onclick="print_lead_information(); return false;" data-placement="bottom"
               title="<?php echo _l('print'); ?>"
               href="#" style="min-height: 3rem !important;">
                <i class="fa fa-print line-height-25"></i>
            </a>
        </div>
        <?php
        $client = false;
        ...
        <?php if ($client && (has_permission('customers', '', 'view') || is_customer_admin(get_client_id_by_lead_id($lead->id)))) { ?>
            <a data-toggle="tooltip" class="btn btn-success pull-right lead-top-btn lead-view mr-4" data-placement="top"
               ...
               href="<?php echo admin_url('clients/client/' . get_client_id_by_lead_id($lead->id)); ?>">
                <i class="fa fa-user-o line-height-25"></i>
            </a>
        <?php } ?>
        <?php if (total_rows('tblclients', array('leadid' => $lead->id)) == 0) { ?>
            <a href="#" data-toggle="tooltip" data-title="<?php echo $convert_to_client_tooltip_email_exists; ?>"
               class="btn btn-success pull-right lead-convert-to-customer mr-4 lead-top-btn lead-view"
    ...
    <div class="row">
        <div class="lead-view mt-4<?php if (!isset($lead)) {
            echo ' hide';
        } ?>" id="leadViewWrapper">
        ...
        <div class="lead-edit<?php if (isset($lead)) {
            ...
            <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="checkbox-inline pl-0 checkbox checkbox-primary<?php if (isset($lead)) {
                            echo ' hide';
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    ...
                                    }; ?> id="lead_public" class="form-check-input"/>
                                    <span class="checkbox-icon"></span>
                                    <span><?php echo _l('lead_public'); ?></span>
                                </label>
                            </div>

                        </div>
                        <?php if (!isset($lead)) { ?>
                            <div class="checkbox-inline checkbox checkbox-primary mt-2">
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="checkbox" name="contacted_today" id="contacted_today" checked
                                               class="form-check-input"/>
                                        <span class="checkbox-icon"></span>
                                        <span><?php echo _l('lead_add_edit_contacted_today'); ?></span>
                                    </label>
                                </div>
                            </div>
                        <?php } ?>
            ...
            <div class="col-md-12 mtop15 custom-field-wrapper">
    ...
    <?php if ($lead_locked == false) { ?>
        <div class="lead-edit<?php if (isset($lead)) {
            ...
            <hr class="mt-4 mb-4"/>
            <button type="submit" class="btn btn-info pull-right lead-save-btn ml-4"
