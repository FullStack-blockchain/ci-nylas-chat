<div class="widget card p-3 m-b-15" id="widget-<?php echo basename(__FILE__,".php"); ?>" data-name="<?php echo _l('user_widget'); ?>">
   <div class="user-data">
      <div class="card-body home-activity">
            ...
            <div class="horizontal-tabs">
               <ul class="nav nav-tabs nav-tabs-horizontal" role="tablist">
                  ...
                  <li role="presentation">
                     ...
                     <?php
                        ...
                        if($total_reminders > 0){
                          echo '<span class="badge badge-circle badge-primary">'.$total_reminders.'</span>';
                        }
                        ?>
                     </a>
                  </li>
                  ...
                  <li role="presentation">
                     ...
                     <?php if($total_undismissed_announcements != 0){ echo '<span class="badge badge-circle badge-primary">'.$total_undismissed_announcements.'</span>';} ?>
                     </a>
                  </li>
                  <?php } ?>
                  <?php if(is_admin()){ ?>
               ...
               <div class="tab-content p-1">
                  <div role="tabpanel" class="tab-pane active" id="home_tab_tasks">
                     <a href="<?php echo admin_url('tasks/list_tasks'); ?>" class="m-b-20 view-all-link full-width"><?php echo _l('home_widget_view_all'); ?></a>
                  ...
                  <div role="tabpanel" class="tab-pane" id="home_tab_tickets">
                     <a href="<?php echo admin_url('tickets'); ?>" class="m-b-20 inline-block full-width"><?php echo _l('home_widget_view_all'); ?></a>
                     <div class="clearfix"></div>
                  ...
                  <div role="tabpanel" class="tab-pane" id="home_my_projects">
                     <a href="<?php echo admin_url('projects'); ?>" class="m-b-20 inline-block full-width"><?php echo _l('home_widget_view_all'); ?></a>
                     <div class="clearfix"></div>
                  ...
                  <div role="tabpanel" class="tab-pane" id="home_my_reminders">
                     <a href="<?php echo admin_url('misc/reminders'); ?>" class="m-b-20 inline-block full-width">
                  ...
                  <div role="tabpanel" class="tab-pane" id="home_announcements">
                     <?php if(is_admin()){ ?>
                     <a href="<?php echo admin_url('announcements'); ?>" class="m-b-20 inline-block full-width"><?php echo _l('home_widget_view_all'); ?></a>
                     <div class="clearfix"></div>
                     <?php } ?>
                  ...
                  <div role="tabpanel" class="tab-pane" id="home_tab_activity">
                     <a href="<?php echo admin_url('utilities/activity_log'); ?>" class="m-b-20 inline-block full-width"><?php echo _l('home_widget_view_all'); ?></a>
                     <div class="clearfix"></div>
