<div class="modal-header task-single-header position-relative" data-task-single-id="<?php echo $task->id; ?>"
    ...
    <?php if ($task->is_public == 0) { ?>
        <br/>
        <small class="no-margin color-white public-text">
    ...
    <div class="row">
        <div class="col-md-8 task-single-col-left">
            <?php if (!empty($task->rel_id)) {
                ...
                echo '<h4 class="bold f-15 mb-4">' . _l('task_single_related') . ': <a href="' . $task_rel_value['link'] . '" target="_blank">' . $task_rel_value['name'] . '</a>';
                       ...
                       style="<?php echo 'margin-' . (is_rtl() ? 'left' : 'right') . ':5px !important'; ?>">
                        ...
                        <a href="#" class="btn btn-info" id="task-single-mark-complete-btn" autocomplete="off"
                           ...
                           title="<?php echo _l('task_single_mark_as_complete'); ?>">
                            <i class="line-height-25 fa fa-check"></i>
                        </a>
                    </p>
                       ...
                       style="<?php echo 'margin-' . (is_rtl() ? 'left' : 'right') . ':5px !important'; ?>">
                        <a href="#" class="btn btn-default" data-toggle="tooltip"
                           ...
                           onclick="task_tracking_stats(<?php echo $task->id; ?>); return false;">
                            <i class="line-height-25 fa fa-bar-chart"></i>
                        </a>
                    </p>
                <?php } ?>
                <p class="pull-left btn-group"
                   style="<?php echo 'margin-' . (is_rtl() ? 'left' : 'right') . ':5px !important'; ?>">
                    <a href="#" class="btn btn-default" data-toggle="tooltip"
                       ...
                       onclick="slideToggle('#task_single_timesheets'); return false;">
                        <i class="line-height-25 fa fa-th-list"></i>
                    </a>
                </p>
                <?php if ($task->billed == 0) {
                    $is_assigned = $task->current_user_is_assigned;
                    if (!$this->tasks_model->is_timer_started($task->id)) { ?>
                        <p class="pull-left"<?php if (!$is_assigned) { ?> data-toggle="tooltip" data-title="<?php echo _l('task_start_timer_only_assignee'); ?>"<?php } ?>
                           style="<?php echo 'margin-' . (is_rtl() ? 'left' : 'right') . ':5px !important'; ?>">
                            <a href="#" class="mbot10 btn<?php if (!$is_assigned || $task->status == 5) {
                                ...
                                <i class="line-height-25 fa fa-clock-o"></i> <?php echo _l('task_start_timer'); ?>
                            </a>
                        </p>
                    <?php } else { ?>
                        <p class="pull-left">
                            <a href="#" data-toggle="popover"
                               ...
                               class="btn mbot10 btn-danger<?php if (!$is_assigned) {
                                ...
                                <i class="line-height-25 fa fa-clock-o"></i> <?php echo _l('task_stop_timer'); ?>
                            </a>
                        </p>
                    <?php } ?>
                <?php } ?>
            ...
            <div class="clearfix"></div>
            <h4 class="th f-15 mbot15 pull-left"><?php echo _l('task_view_description'); ?></h4>
            <?php if (has_permission('tasks', '', 'edit')) { ?><a href="#"
                                                                  onclick="edit_task_inline_description(this,<?php echo $task->id; ?>); return false;"
                                                                  class="pull-left mt-1 ml-1 font-medium-xs"><i
            ...
            <div class="row checklist-items-wrapper">
                <div class="col-md-12">
                    <div id="checklist-items" style="margin-bottom: 2rem;">
            ...
            <?php if (count($task->attachments) > 0) { ?>
                <div class="row task_attachments_wrapper">
                    <div class="col-md-12" id="attachments">
                        <hr/>
                        <h4 class="th f-15 font-weight-bold"><?php echo _l('task_view_attachments'); ?></h4>
                        <div class="row">
                            <?php
                            $i = 1;
            ...
            <a href="#" id="taskCommentSlide" onclick="slideToggle('.tasks-comments'); return false;">
                <h4 class="mbot20 f-15"><?php echo _l('task_comments'); ?></h4>
            </a>
            <div class="tasks-comments inline-block full-width simple-editor"<?php if (count($task->comments) == 0) {
                echo ' style="display:none"';
            } ?>>
                <?php echo form_open_multipart(admin_url('tasks/add_task_comment'), array('id' => 'task-comment-form', 'class' => '', 'style' => 'min-height:auto;background-color:#fff;')); ?>

                <div class="dropzone dropzone-manual card">
                    ...
                    foreach ($task->comments as $comment) {
                        ...
                        if ($comment['staffid'] != 0) {
                            $comments .= '<a href="' . admin_url('profile/' . $comment['staffid']) . '" target="_blank">' . staff_profile_image($comment['staffid'], array(
                                    ...
                                    'media-object img-circle pull-left mr-2'
                                )) . '</a>';
                        } elseif ($comment['contact_id'] != 0) {
                            $comments .= '<img src="' . contact_profile_image_url($comment['contact_id']) . '" class="client-profile-image-small media-object img-circle pull-left mr-2">';
                        }
        ...
        <div class="col-md-4 task-single-col-right">
                    ...
                    <ul>
                        ...
                        <?php if (has_permission('tasks', '', 'create')) { ?>
                            ...
                            if (count($task->assignees) > 0) {
                                $copy_template .= '<div class="form-check">
                                                        <label class="form-check-label">
                                                            <input type="checkbox" name="copy_task_assignees" id="copy_task_assignees" checked/>
                                                            <span class="checkbox-icon"></span>
                                                            <span>' . _l('task_single_assignees') . '</span>
                                                        </label>
                                                    </div>';
                            }
                            if (count($task->followers) > 0) {
                                $copy_template .= '<div class="form-check">
                                                        <label class="form-check-label">
                                                            <input type="checkbox" name="copy_task_followers" id="copy_task_followers" checked/>
                                                            <span class="checkbox-icon"></span>
                                                            <span>' . _l('task_single_followers') . '</span>
                                                        </label>
                                                    </div>';
                            }
                            if (count($task->checklist_items) > 0) {
                                $copy_template .= '<div class="form-check">
                                                        <label class="form-check-label">
                                                            <input type="checkbox" name="copy_task_checklist_items" id="copy_task_checklist_items" checked/>
                                                            <span class="checkbox-icon"></span>
                                                            <span>' . _l('task_checklist_items') . '</span>
                                                        </label>
                                                    </div>';
                            }
                            if (count($task->attachments) > 0) {
                                $copy_template .= '<div class="form-check">
                                                        <label class="form-check-label">
                                                            <input type="checkbox" name="copy_task_attachments" id="copy_task_attachments" checked/>
                                                            <span class="checkbox-icon"></span>
                                                            <span>' . _l('task_view_attachments') . '</span>
                                                        </label>
                                                    </div>';
                            }
            ...
            <div class="task-info task-status task-info-status">
                <h5>
                    <i class="fa fa-<?php if ($task->status == 5) {
                        ...
                        echo 'star-half-o';
                    } ?> pull-left task-info-icon fa-fw fa-lg s-4"></i><?php echo _l('task_status'); ?>:
         ...
         <span class="content-menu hide">
            ...
            <?php if ($task->status == 5) { ?>
                <div class="task-info task-info-finished">
                    <h5><i class="fa task-info-icon fa-fw fa-lg pull-left fa-check s-4"></i>
            ...
            <div class="task-info task-single-inline-wrap task-info-start-date">
                <h5><i class="fa task-info-icon fa-fw fa-lg fa-calendar-plus-o pull-left fa-margin s-4"></i>
            ...
            <div class="task-info task-info-due-date task-single-inline-wrap<?php if (!$task->duedate && !has_permission('edit', '', 'tasks')) {
                ...
                <h5><i class="fa fa-calendar-check-o task-info-icon fa-fw fa-lg pull-left s-4"></i>
            ...
            <div class="task-info task-info-priority">
                <h5>
                    <i class="fa task-info-icon fa-fw fa-lg pull-left fa-bolt s-4"></i>
         ...
         <?php echo task_priority($task->priority); ?>
            ...
            <?php if ((has_permission('tasks', '', 'create') || has_permission('tasks', '', 'edit'))) { ?>
                <div class="task-info task-info-hourly-rate">
                    <h5><i class="fa task-info-icon fa-fw fa-lg pull-left fa-clock-o s-4"></i>
                ...
                <div class="task-info task-info-billable">
                    <h5><i class="fa task-info-icon fa-fw fa-lg pull-left fa fa-credit-card s-4"></i>
            ...
            <?php if ($task->current_user_is_assigned || total_rows('tbltaskstimers', array('task_id' => $task->id, 'staff_id' => get_staff_user_id())) > 0) { ?>
                <div class="task-info task-info-user-logged-time">
                    <h5>
                        <i class="fa fa-asterisk task-info-icon fa-fw fa-lg s-4"
            ...
            <?php if (has_permission('tasks', '', 'create')) { ?>
                <div class="task-info task-info-total-logged-time">
                    <h5>
                        <i class="fa task-info-icon fa-fw fa-lg fa-clock-o s-4"></i><?php echo _l('task_total_logged_time'); ?>
         ...
         <?php echo seconds_to_time_format($this->tasks_model->calc_task_total_time($task->id)); ?>
            ...
            foreach ($custom_fields as $field) { ?>
                ...
                <div class="task-info">
                    <h5 class="task-info-custom-field task-info-custom-field-<?php echo $field['id']; ?>">
                        <i class="fa task-info-icon fa-fw fa-lg fa-square-o s-4"></i>
            ...
            <?php if (has_permission('tasks', '', 'edit') || has_permission('tasks', '', 'create')) { ?>
                <div class="simple-bootstrap-select mb-2">
            ...
            <div class="task_users_wrapper">
                ...
                foreach ($task->assignees as $assignee) {
                    ...
                    if (has_permission('tasks', '', 'edit') || has_permission('tasks', '', 'create')) {
                        $_remove_assigne = ' <a href="#" class="remove-task-user" onclick="remove_assignee(' . $assignee['id'] . ',' . $task->id . '); return false;"><i class="fa fa-remove text-danger"></i></a>';
                    }
                    $_assignees .= '
   ...
   <a href="' . admin_url('profile/' . $assignee['assigneeid']) . '" target="_blank">' . staff_profile_image($assignee['assigneeid'], array(
            ...
            <div class="task_users_wrapper">
                ...
                foreach ($task->followers as $follower) {
                    $_remove_follower = '';
                    if (has_permission('tasks', '', 'edit') || has_permission('tasks', '', 'create')) {
                        $_remove_follower = ' <a href="#" class="remove-task-user text-danger" onclick="remove_follower(' . $follower['id'] . ',' . $task->id . '); return false;"><i class="fa fa-remove text-danger"></i></a>';
                    }
                    $_followers .= '
