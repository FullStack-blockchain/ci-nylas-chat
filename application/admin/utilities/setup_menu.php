...
<link type="text/css" rel="stylesheet" href="<?php echo base_url('assets/css/menu-setup.css'); ?>">
<main>
    <div id="wrapper">
        <?php init_aside(); ?>
                                    ...
                                    <div class="card-body">
                                        <div class="_buttons">
                                            <a href="#" onclick="save_menu();return false;"
                                               class="btn btn-secondary"><?php echo _l('utilities_menu_save'); ?></a>
                                            <a href="<?php echo admin_url('utilities/reset_setup_menu'); ?>"
                                                            ...
                                                            <div class="menu-options main-item-options"
                                                                ...
                                                                <div class="input-group mbot15">
                                                                    ...
                                                                    <input type="text"
                                                                           ...
                                                                           name="name-menu-item-<?php echo $item->id; ?>">
                                                                ...
                                                                <div class="input-group mbot15">
                                                                    ...
                                                                    <input type="text" disabled
                                                                           ...
                                                                           name="url-menu-item-<?php echo $item->id; ?>">
                                                                    <span class="input-group-addon"><i
                                                                                class="fa fa-question"
                                                                                data-toggle="tooltip"
                                                                                data-placement="left"
                                                                ...
                                                                <div class="input-group">
                                                                    <input type="text"
                                                                           value="<?php echo $item->icon; ?>"
                                                                           class="form-control main-item-icon icon-picker">
                                                                    ...
                                                                    foreach ($item->children as $submenu) { ?>
                                                                        <li class="dd-item dd3-item sub-items"
                                                                            ...
                                                                            <div class="menu-options sub-item-options"
                                                                                ...
                                                                                <div class="input-group">
                                                                                    <input type="text"
                                                                                           value="<?php echo $submenu->name; ?>"
                                                                                           class="form-control sub-item-name"
                                                                                           name="name-menu-item-<?php echo $submenu->id; ?>">
                                                                                    <span class="input-group-addon"><i
                                                                                                class="fa fa-question"
                                                                                                data-toggle="tooltip"
                                                                                                data-placement="left"
                                                                                ...
                                                                                <div class="input-group">
                                                                                    ...
                                                                                    <input type="text" disabled
                                                                                           ...
                                                                                           name="url-menu-item-<?php echo $submenu->id; ?>">
                                                                                    <span class="input-group-addon"><i
                                                                                                class="fa fa-question"
                                                                                                data-toggle="tooltip"
                                                                                                data-placement="left"
...
<?php init_tail(); ?>
<script src="<?php echo base_url(); ?>assets-old/plugins/jquery-nestable/jquery.nestable.js"></script>
<link href="<?php echo base_url(); ?>assets-old/plugins/font-awesome-icon-picker/css/fontawesome-iconpicker.min.css"
      rel="stylesheet">
<script src="<?php echo base_url(); ?>assets-old/plugins/font-awesome-icon-picker/js/fontawesome-iconpicker.min.js"></script>
<script>
