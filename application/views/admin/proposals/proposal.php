                ...
                <div id="proposal-manage" class="page-layout simple left-sidebar-floating">
                    ...
                    <div class="page-header bg-primary text-auto row no-gutters align-items-center justify-content-between p-4">
                        ...
                        <div class="col-md col-sm-12">
                            <span class="logo-text h4"><?php if (!isset($proposal)) echo _l('add_new'); else echo _l('edit');
                                echo " " . _l('proposal'); ?></span>
                        </div>
                    ...
                    <div class="page-content p-4 p-sm-6">
                        <div class="content accounting-template">
                            <div class="row">
                                                ...
                                                <div class="col-md-6 border-right">
                                                    ...
                                                    <div class="form-group mtop10 no-mbot">
                                                        ...
                                                        <div class="onoffswitch">
                                                            <label class="switch onoffswitch-label" for="allow_comments"
                                                                   data-toggle="tooltip"
                                ...
                                <div class="row proposal-form-save-buttons">
                                    ...
                                    <div class="col p-0 ml-4">
                                        <button class="btn btn-info mleft5 proposal-form-submit transaction-submit"
                                                type="button">
                                            <?php echo _l('submit'); ?>
                                        </button>
                                    </div>
