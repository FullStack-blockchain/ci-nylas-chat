                ...
                foreach ($encodeExplorer->files as $key => $file) {
                    ...
                    <tr class="rowa <?php echo $gallclass; ?>" <?php echo $gallid; ?>>
                        ...
                        if ($file->isValidForAudio() ) { 
                            ...
                            <a type="audio/<?php echo strtolower($ext); ?>" class="sm2_button" href="<?php echo $linkaudio; ?>&audio=play">
                                ...
                                if ($gateKeeper->isAllowed('rename_enable') 
                                    ...
                                    <div class="icon rename text-center minibutt">
                                        <a class="round-butt" href="javascript:void(0)" data-thisdir="<?php echo $thisdir; ?>" 
                                            data-thisext="<?php echo $ext; ?>" data-thisname="<?php echo $normalizedName; ?>">
                        ...
                        <td class="name" data-order="<?php echo $thisname; ?>" data-filter="<?php echo $normalized; ?>">
                            <div class="relative">
                                <a href="<?php echo $downlink; ?>" 
                                    <?php
                                    if ($file->isValidForThumb() || $file->isValidForVideo()) {
                                ...
                                <div class="grid-item-title"><?php echo $normalized; ?></div>
                                    ...
                                    if ($gateKeeper->isAllowed('rename_enable')) { ?>
                                        <li class="rename">
                                            <a href="javascript:void(0)" 
                                                ...
                                                data-thisname="<?php echo $normalizedName; ?>">
