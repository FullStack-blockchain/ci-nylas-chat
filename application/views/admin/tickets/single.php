...
<link type="text/css" rel="stylesheet" href="<?php echo base_url('assets/css/support-single.css'); ?>">
<main>
    <div id="wrapper">
        <?php init_aside(); ?>
        ...
        <div class="content-wrapper">
            ...
            <div class="content custom-scrollbar">
                ...
                <div id="single-ticket-manage" class="page-layout simple left-sidebar-floating">
                    ...
                    <div class="page-content p-4 p-sm-6">
                        ...
                        <div class="card">
                            <div class="card-body pb-0">
                                <div class="row">
                                    <div class="col-md-8">
                                        <h4 class="mtop4 mbot20 pull-left">
                                        ...
                                        <?php echo '<div class="label mt-1 mb-1' . (is_mobile() ? ' ' : ' ml-4 ') . 'p-2 pull-left single-ticket-status-label" style="background:' . $ticket->statuscolor . '">' . ticket_status_translate($ticket->ticketstatusid) . '</div>'; ?>
                        ...
                        <div class="card">
                            <div class="card-body p-0">
                                    ...
                                    <div class="horizontal-tabs">
                                        <ul class="nav nav-tabs no-margin nav-tabs-horizontal" role="tablist">
                                            <li role="presentation"
                                                class="<?php if (!$this->session->flashdata('active_tab')) {
                                                    echo 'active';
                                                } ?>">
                                ...
                                <div class="tab-content pl-4 pr-4 pb-4">
                                    <div role="tabpanel"
                                         class="tab-pane pt-2 <?php if (!$this->session->flashdata('active_tab')) {
                                             echo 'active';
                                         } ?>" id="addreply">
                                        ...
                                        <?php if (count($tags) > 0) { ?>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <?php echo '<b><i class="fa fa-tag" aria-hidden="true"></i> ' . _l('tags') . ':</b> ' . render_tags($tags); ?>
                                                    <hr class="mt-3 mb-3"/>
                                                </div>
                                            </div>
                                        <?php } ?>
                                        <?php if (sizeof($ticket->ticket_notes) > 0) { ?>
                                            <div class="row">
                                                <div class="col-md-12 mbot15">
                                                    <h5 class="bold"><?php echo _l('ticket_single_private_staff_notes'); ?></h5>
                                                                            ...
                                                                            <div data-note-edit-textarea="<?php echo $note['id']; ?>"
                                                                                 class="hide inline-block full-width">
                                                                                    <textarea name="description"
                                                                                              class="form-control edit-note-area"
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <div class="btn-group">
                                                <a href="<?php echo admin_url('tickets/delete/' . $ticket->ticketid); ?>"
                                                   class="btn btn-danger _delete btn-ticket-label p-1"
                                                   style="min-height: 3rem !important;">
                                                    <i class="fa fa-remove line-height-25"></i>
                                                </a>
                                            </div>
                                            <?php if (!empty($ticket->priority_name)) { ?>
                                                <span class="badge badge-primary badge-pill inline-block p-2">
                        ...
                        <?php echo _l('department') . ': ' . $ticket->department_name; ?>
                                            ...
                                            <?php if ($ticket->assigned != 0) { ?>
                                                <span class="badge badge-secondary badge-pill inline-block p-2">
                           ...
                           <span class="text-has-action">
                              <?php echo _l('ticket_single_last_reply', time_ago($ticket->lastreply)); ?>
                                            ...
                                            <div class="panel_s ticket-reply-tools">
                                                <div class="btn-bottom-toolbar text-right mb-4" style="display: none">
                                                    <button type="submit" class="btn btn-info"
                                                            data-form="#single-ticket-form"
                                                            id="single-ticket-form-button"
                                                            autocomplete="off"
                                                ...
                                                <div class="panel-body">
                                                    <div class="row">
                                                            ...
                                                            <?php if ($ticket->assigned !== get_staff_user_id()) { ?>
                                                                <div class="form-check mt-4">
                                                                    <label class="form-check-label">
                                                                        ...
                                                                        <span><?php echo _l('ticket_single_assign_to_me_on_update'); ?></span>
                                                                    </label>
                                                                </div>
                                                            <?php } ?>
                                                            <div class="form-check mt-4">
                                                                <label class="form-check-label">
                                                                    <input type="checkbox" <?php echo do_action('ticket_add_response_and_back_to_list_default', 'checked'); ?>
                                                                           name="ticket_add_response_and_back_to_list"
                                                                           value="1"
                                                                           id="ticket_add_response_and_back_to_list"
                                                                           class="form-check-input"/>
                                                                    <span class="checkbox-icon"></span>
                                                                    <span><?php echo _l('ticket_add_response_and_back_to_list'); ?></span>
                                                                </label>
                                                            </div>
                                                        </div>
                                                        <?php
                                                        ...
                                                        <div class="col-md-7 _buttons mtop20">
                                                            ...
                                                            $use_knowledge_base = get_option('use_knowledge_base');
                                                            ?>
                                                            <select id="insert_predefined_reply"
                                    ...
                                    <div role="tabpanel" class="tab-pane pt-2" id="note">
                                        ...
                                        <a class="btn btn-info pull-right add_note_ticket mb-3 mt-3"><?php echo _l('ticket_single_add_note'); ?></a>
                                    </div>
                                    <div role="tabpanel" class="tab-pane pt-2" id="othertickets">
                                    ...
                                    <div role="tabpanel" class="tab-pane pt-2" id="tasks">
                                        <?php init_relation_tasks_table(array('data-new-rel-id' => $ticket->ticketid, 'data-new-rel-type' => 'ticket')); ?>
                                    </div>
                                    <div role="tabpanel"
                                         class="tab-pane pt-2 <?php if ($this->session->flashdata('active_tab_settings')) {
                                             echo 'active';
                                         } ?>" id="settings">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group select-placeholder">
                                                    ...
                                                    <select name="contactid" id="contactid" class="ajax-search"
                                                            ...
                                                            data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>"<?php if (!empty($ticket->from_name) && !empty($ticket->ticket_email)) {
                        ...
                        <div class="card">
                            <div class="card-body <?php if ($ticket->admin == NULL) {
                                echo 'client-reply';
                            } ?>">
                                <div class="row">
                                        ...
                                        <?php if (count($ticket->attachments) > 0) {
                                            ...
                                            foreach ($ticket->attachments as $attachment) {
                                                ...
                                                <a href="<?php echo site_url('download/file/ticket/' . $attachment['id']); ?>"
                                                   class="display-block mbot5"<?php if ($is_image) { ?> data-lightbox="attachment-ticket-<?php echo $ticket->ticketid; ?>" <?php } ?>>
                        ...
                        <?php foreach ($ticket_replies as $reply) { ?>
                            <div class="card">
                                <div class="card-body <?php if ($reply['admin'] == NULL) {
                                    echo 'client-reply';
                                } ?>">
                                    <div class="row">
                                        <div class="col-md-3 border-right">
                                            ...
                                            <?php if (has_permission('tasks', '', 'create')) { ?>
                                                <a href="#" class="pull-left btn btn-default ml-4 btn-xs"
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <?php if (count($reply['attachments']) > 0) {
                                                ...
                                                foreach ($reply['attachments'] as $attachment) {
                                                    ...
                                                    ?>
                                                    <a href="<?php echo site_url('download/file/ticket/' . $attachment['id']); ?>"
                                                       class="display-block mbot5"<?php if ($is_image) { ?> data-lightbox="attachment-reply-<?php echo $reply['id']; ?>" <?php } ?>>
                                                        <i class="<?php echo get_mime_class($attachment['filetype']); ?>"></i> <?php echo $attachment['file_name']; ?>
                                                        <?php if ($is_image) { ?>
                                                            <img class="mtop5"
                                                                 src="<?php echo site_url('download/preview_image?path=' . protected_file_url_by_path($path) . '&type=' . $attachment['filetype']); ?>">
...
<!--                        --><?php //} ?>
            ...
            <nav id="footer" class="bg-white text-auto row no-gutters align-items-center px-6">
                <button type="submit" class="btn btn-info"
                        data-form="#single-ticket-form"
                        autocomplete="off" id="add_response"
                        data-loading-text="<?php echo _l('wait_text'); ?>"
                        class="btn btn-secondary text-capitalize pull-right"><?php echo _l('ticket_single_add_response'); ?></button>
            </nav>
        </div>
...
<script>
    $(function () {
        ...
        $("#add_response").on("click", function (e) {
            e.preventDefault();
