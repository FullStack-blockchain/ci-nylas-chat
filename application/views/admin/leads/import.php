                ...
                <div id="lead-manage" class="page-layout simple left-sidebar-floating">
                    ...
                    <div class="page-header bg-primary text-auto row no-gutters align-items-center justify-content-between p-4">
                        ...
                        <div class="col-md col-sm-12">
                            <div>
                                <span class="logo-text h4"><?php echo _l('import_leads'); ?></span>
                            </div>
                        </div>
                        ...
                        <div class="col-auto ml-4">
                            ...
                            <button type="submit" class="btn btn-success pull-right">Download Sample</button>
                            <?php echo form_close(); ?>
                        </div>
                    </div>
                    <!-- / HEADER -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <?php if (!isset($simulate)) { ?>
                                    <ul>
                                        <li>1. Your CSV data should be in the format below. The first line of your CSV
                                            file should be the column headers as in the table example. Also make sure
                                            that your file is <b>UTF-8</b> to avoid unnecessary <b>encoding problems</b>.
                                        </li>
                                        <li>2. If the column <b>you are trying to import is date</b> make sure that is
                                            formatted in format Y-m-d (<?php echo date('Y-m-d'); ?>)
                                        </li>
                                        ...
                                        <table class="table table-hover table-bordered">
                                            ...
                                            <tr>
                                                ...
                                                <?php foreach ($leads_db_fields as $field) {
                                                    ...
                                                    ?>
                                                    <?php $total_fields++; ?>
                                                    <th class="bold"><?php if ($field == 'name') {
                                ...
                                <?php if (isset($simulate)) { ?>
                                    <h4 class="bold">Simulation Data
                                        <small class="text-info">Max 100 rows are shown</small>
                                    </h4>
                                    <p class="text-info">If you are satisfied with the results upload the file again and
                                        click import</p>
                                    <div class="table-responsive no-dt">
                                        <table class="table table-hover table-bordered">
                                            <thead>
