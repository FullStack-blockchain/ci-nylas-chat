    ...
    <div id="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="content">
                ...
                <div id="manage_staff_profile" class="page-layout simple left-sidebar-floating">
                            ...
                            <div class="col-md-7">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label for="email"
                                                   class="control-label"><?php echo _l('staff_add_edit_email'); ?></label>
                                            <input type="email"<?php if (has_permission('staff', '', 'edit')) { ?> name="email"<?php } else { ?> disabled="true"<?php } ?>
                                                   class="form-control" value="<?php echo $member->email; ?>"
                                                   id="email">
                                        </div>
