...
class Migration_Version_111 extends CI_Migration
{
  ...
  public function up()
  {
    ...
    if(file_exists(FCPATH.'assets-old/js/editor.js')){
      @unlink(FCPATH.'assets-old/js/editor.js');
    }

    if(is_dir(FCPATH.'assets-old/plugins/ContentTools')){
      if(is_dir(FCPATH.'assets-old/plugins/ContentTools/images')){
        @delete_dir(FCPATH.'assets-old/plugins/ContentTools/images');
      }

      if(is_dir(FCPATH.'assets-old/plugins/ContentTools/build')){
        if(is_dir(FCPATH.'assets-old/plugins/ContentTools/build/images')){
          @delete_dir(FCPATH.'assets-old/plugins/ContentTools/build/images');
        }
        @delete_dir(FCPATH.'assets-old/plugins/ContentTools/build');
      }

      if(is_dir(FCPATH.'assets-old/plugins/ContentTools')){
        @delete_dir(FCPATH.'assets-old/plugins/ContentTools');
      }
    }
