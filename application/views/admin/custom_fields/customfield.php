    ...
    <div id="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="content custom-scrollbar">
                ...
                <div id="add_new_custom_field" class="page-layout simple left-sidebar-floating">
                            ...
                            <div class="col-md-8 col-md-offset-2">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="no-margin">
                                            ...
                                            <?php if (isset($custom_field)) { ?>
                                                <a href="<?php echo admin_url('custom_fields/field'); ?>"
                                                   class="btn btn-success pull-right"><?php echo _l('new_custom_field'); ?></a>
                                                <div class="clearfix"></div>
                                            <?php } ?>
                                        </h4>
                                        <hr class="mt-4 mb-4"/>
                                        <div class="company_field_info mt-5 alert alert-info<?php if (isset($custom_field) && $custom_field->fieldto != 'company' || !isset($custom_field)) {
                                            echo ' hide';
                                        } ?>">
                                        ...
                                        <div class="customers_field_info mt-5 alert alert-info<?php if (isset($custom_field) && $custom_field->fieldto != 'customers' || !isset($custom_field)) {
                                            echo ' hide';
                                        } ?>">
                                            <?php echo _l('custom_field_info_format_embed_info', array(
                                                _l('clients'),
                                        ...
                                        <div class="items_field_info mt-5 alert alert-warning<?php if (isset($custom_field) && $custom_field->fieldto != 'items' || !isset($custom_field)) {
                                            echo ' hide';
                                        } ?>">
                                            Custom fields for items can't be included in calculation of totals.
                                        </div>
                                        <div class="proposal_field_info mt-5 alert alert-info<?php if (isset($custom_field) && $custom_field->fieldto != 'proposal' || !isset($custom_field)) {
                                            echo ' hide';
                                        } ?>">
                                            <?php echo _l('custom_field_info_format_embed_info', array(
                                                _l('proposals'),
                                        ...
                                        ?>
                                        <div class="select-placeholder form-group pt-0">
                                        ...
                                        <div class="select-placeholder form-group">
                                            ...
                                            <select name="type" id="type"
                                                    class="selectpicker"<?php if (isset($custom_field) && total_rows('tblcustomfieldsvalues', array('fieldid' => $custom_field->id, 'fieldto' => $custom_field->fieldto)) > 0) {
                                                echo ' disabled';
                                            } ?> data-width="100%"
                                                    data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>"
                                        ...
                                        <div id="options_wrapper"
                                             class="<?php if (!isset($custom_field) || isset($custom_field) && $custom_field->type != 'select' && $custom_field->type != 'checkbox' && $custom_field->type != 'multiselect') {
                                                 echo 'hide';
                                             } ?>">
                                            <span class="pull-left fa fa-question-circle" data-toggle="tooltip"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" max="12" class="form-control" name="bs_column"
                                                       id="bs_column" value="<?php if (!isset($custom_field)) {
                                                    echo 12;
                                                } else {
                                        ...
                                        <div class="form-check mt-5">
                                            <label class="form-check-label">
                                                <input type="checkbox" name="disabled" class="form-check-input"
                                                       id="disabled" <?php if (isset($custom_field) && $custom_field->active == 0) {
                                                    echo 'checked';
                                                } ?>>
                                                <span class="checkbox-icon"></span>
                                                <span><?php echo _l('custom_field_add_edit_disabled'); ?></span>
                                            </label>
                                        </div>

                                        <div class="form-check mt-2 <?php if (!isset($custom_field) || isset($custom_field) && $custom_field->type != 'checkbox') {
                                            echo ' hide';
                                        } ?>">
                                            <label class="form-check-label">
                                                <input type="checkbox" value="1" name="display_inline"
                                                       class="form-check-input"
                                                       id="display_inline" <?php if (isset($custom_field) && $custom_field->display_inline == 1) {
                                                    echo 'checked';
                                                } ?>>
                                                <span class="checkbox-icon"></span>
                                                <span><?php echo _l('display_inline'); ?></span>
                                            </label>
                                        </div>

                                        <div class="form-check mt-2">
                                            <label class="form-check-label">
                                                <input type="checkbox" name="only_admin" class="form-check-input"
                                                       id="only_admin" <?php if (isset($custom_field) && $custom_field->only_admin == 1) {
                                                    echo 'checked';
                                                } ?> <?php if (isset($custom_field) && ($custom_field->fieldto == 'company' || $custom_field->fieldto == 'items')) {
                                                    echo 'disabled';
                                                } ?>>
                                                <span class="checkbox-icon"></span>
                                                <span><?php echo _l('custom_field_only_admin'); ?></span>
                                            </label>
                                        </div>

                                        <div class="form-check mt-2 disalow_client_to_edit <?php if (!isset($custom_field) || (isset($custom_field) && !in_array($custom_field->fieldto, $client_portal_fields)) || (isset($custom_field) && !in_array($custom_field->fieldto, $client_editable_fields))) {
                                            echo 'hide';
                                        } ?>">
                                            <label class="form-check-label">
                                                <input type="checkbox" name="disalow_client_to_edit" class="form-check-input"
                                                       id="disalow_client_to_edit" <?php if (isset($custom_field) && $custom_field->disalow_client_to_edit == 1) {
                                                    echo 'checked';
                                                } ?> <?php if (isset($custom_field) && ($custom_field->fieldto == 'company' || $custom_field->only_admin == '1')) {
                                                    echo 'disabled';
                                                } ?>>
                                                <span class="checkbox-icon"></span>
                                                <span><?php echo _l('custom_field_disallow_customer_to_edit'); ?></span>
                                            </label>
                                        </div>
                                        ...
                                        <div class="form-check mt-2">
                                            <label class="form-check-label">
                                                <input type="checkbox" name="required" class="form-check-input"
                                                       id="required" <?php if (isset($custom_field) && $custom_field->required == 1) {
                                                    echo 'checked';
                                                } ?> <?php if (isset($custom_field) && $custom_field->fieldto == 'company') {
                                                    echo 'disabled';
                                                } ?>>
                                                <span class="checkbox-icon"></span>
                                                <span><?php echo _l('custom_field_required'); ?></span>
                                            </label>
                                        </div>

                                        <p class="bold mt-4"><?php echo _l('custom_field_visibility'); ?></p>


                                        <div class="form-check mt-2">
                                            <label class="form-check-label">
                                                <input type="checkbox" name="show_on_table" class="form-check-input"
                                                       id="show_on_table" <?php if (isset($custom_field) && $custom_field->show_on_table == 1) {
                                                    echo 'checked';
                                                } ?> <?php if (isset($custom_field) && ($custom_field->fieldto == 'company' || $custom_field->fieldto == 'items')) {
                                                    echo 'disabled';
                                                } ?>>
                                                <span class="checkbox-icon"></span>
                                                <span><?php echo _l('custom_field_show_on_table'); ?></span>
                                            </label>
                                        </div>

                                        <div class="form-check mt-2 show-on-pdf <?php if (!isset($custom_field) || (isset($custom_field) && !in_array($custom_field->fieldto, $pdf_fields))) {
                                            echo 'hide';
                                        } ?>">
                                            <label class="form-check-label">
                                                <input type="checkbox" name="show_on_pdf" class="form-check-input"
                                                       id="show_on_pdf" <?php if (isset($custom_field) && $custom_field->show_on_pdf == 1) {
                                                    echo 'checked';
                                                } ?> <?php if (isset($custom_field) && ($custom_field->fieldto == 'company' || $custom_field->fieldto == 'items')) {
                                                    echo 'disabled';
                                                } ?>>
                                                ...
                                                <span><i class="fa fa-question-circle"
                                                         data-toggle="tooltip"
                                                         data-title="<?php echo _l('custom_field_pdf_html_help'); ?>"></i> <?php echo _l('custom_field_show_on_pdf'); ?></span>
                                            </label>
                                        </div>

                                        <div class="form-check mt-2 show-on-client-portal <?php if (!isset($custom_field) || (isset($custom_field) && !in_array($custom_field->fieldto, $client_portal_fields))) {
                                            echo 'hide';
                                        } ?>">
                                            <label class="form-check-label">
                                                <input type="checkbox" name="show_on_client_portal" class="form-check-input"
                                                       id="show_on_client_portal" <?php if (isset($custom_field) && $custom_field->show_on_client_portal == 1) {
                                                    echo 'checked';
                                                } ?> <?php if (isset($custom_field) && ($custom_field->fieldto == 'company' || $custom_field->only_admin == '1')) {
                                                    echo 'disabled';
                                                } ?>>
                                                ...
                                                <span><i class="fa fa-question-circle"
                                                         data-toggle="tooltip"
                                                         data-title="<?php echo _l('custom_field_show_on_client_portal_help'); ?>"></i> <?php echo _l('custom_field_show_on_client_portal'); ?></span>
                                            </label>
                                        </div>

                                        <div class="form-check mt-2 show-on-ticket-form <?php if (!isset($custom_field) || isset($custom_field) && $custom_field->fieldto != 'tickets') {
                                            echo ' hide';
                                        } ?>">
                                            <label class="form-check-label">
                                                <input type="checkbox" value="1" name="show_on_ticket_form" class="form-check-input"
                                                       id="show_on_ticket_form" <?php if (isset($custom_field) && $custom_field->show_on_ticket_form == 1) {
                                                    echo 'checked';
                                                } ?>>
                                                <span class="checkbox-icon"></span>
                                                <span><?php echo _l('show_on_ticket_form'); ?></span>
                                            </label>
                                        </div>

                                        <button type="submit" class="btn btn-secondary pull-right"><?php echo _l('submit'); ?></button>
                                        <?php echo form_close(); ?>
