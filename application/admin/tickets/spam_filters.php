                    ...
                    <div class="page-content p-4 p-sm-6">
                        <div class="card">
                            <div class="panel-body">
                                <div class="_buttons">
                                    <a href="#" class="btn btn-info pull-left display-block mb-3"
                                ...
                                <ul class="nav nav-tabs" role="tablist">
                                    <li role="presentation" class="nav-item active">
                                        <a href="#senders" aria-controls="senders"
                                           role="tab" class="nav-link"
                                           data-toggle="tab"><?php echo _l('spam_filter_blocked_senders'); ?></a>
                                    </li>
                                    <li role="presentation" class="nav-item">
                                        <a href="#subjects" aria-controls="subjects" role="tab" class="nav-link"
                                           data-toggle="tab"><?php echo _l('spam_filter_blocked_subjects'); ?></a>
                                    </li>
                                    <li role="presentation" class="nav-item">
                                        <a href="#phrases" aria-controls="phrases" role="tab" class="nav-link"
                                           data-toggle="tab"><?php echo _l('spam_filter_blocked_phrases'); ?></a>
                                    </li>
                                </ul>
