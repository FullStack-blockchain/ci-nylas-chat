        ...
        <div class="media sales-note-wrapper">
            ...
            <div class="media-body">
                ...
                <?php if ($note['addedfrom'] == get_staff_user_id() || is_admin()) { ?>
                    <a href="#" class="pull-right btn btn-icon-square text-danger btn-danger mr-1"
                       onclick="delete_sales_note(this,<?php echo $note['id']; ?>);return false;"><i
                                class="fa fa fa-times"></i></a>
                    <a href="#" class="pull-right btn btn-icon-square mr-1"
                       onclick="toggle_edit_note(<?php echo $note['id']; ?>);return false;"><i
                                class="fa fa-pencil-square-o"></i></a>
                <?php } ?>
                <h5 class="media-heading bold"><a
                            href="<?php echo admin_url('profile/' . $note["addedfrom"]); ?>"><?php echo get_staff_full_name($note['addedfrom']); ?></a>
                </h5>
