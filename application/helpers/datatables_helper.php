...
function render_datatable($headings = [], $class = '', $additional_classes = [''], $table_attributes = [])
{
    ...
    $table = '<div class="' . $IEfix . '"><table' . $_table_attributes . 'class="dt-table-loading mdl-data-table table  table-' . $class . '' . $_additional_classes . '">';
    $table .= '<thead>';
    $table .= '<tr>';
    foreach ($headings as $heading) {
        if (!is_array($heading)) {
            $table .= '<th><div class="table-header"><span class="column-title">' . $heading . '</span></div></th>';
        } else {
            $th_attrs = '';
            ...
            $table .= '<th' . $th_attrs . '><div class="table-header"><span class="column-title">' . $heading['name'] . '</span></div></th>';
        }
    }
    $table .= '</tr>';
    $table .= '</thead>';
