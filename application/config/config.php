...
if (file_exists(APPPATH.'config/app-config.php')) {
    ...
    echo '<p>2. If you are installing manually rename the config file located in application/config/app-config.php to app-config.php and populate the defined fields.</p>';
    die();
}
