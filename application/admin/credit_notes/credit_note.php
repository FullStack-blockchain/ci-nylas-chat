                ...
                <div id="credit-note-manage" class="page-layout simple left-sidebar-floating">
                    ...
                    <div class="page-header bg-primary text-auto row no-gutters align-items-center justify-content-between p-4">
                        <div class="col col-md mb-3">
                            <span class="logo-text h4"><?php if (!isset($credit_note)) echo _l('add_new'); else echo _l('edit');
                                echo " " . _l('credit_note'); ?></span>
                        </div>
                    </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="f_client_id">
                                                        <div class="form-group select-placeholder">
                                                            <label for="clientid"
                                                                   class="control-label"><?php echo _l('client'); ?></label>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            ...
                                                            <a href="#" class="edit_shipping_billing_info"
                                                               data-toggle="modal"
              ...
              <span class="input-group-addon">
                ...
                <?php } ?>
                 ...
                 <span id="prefix_year" class="format-mm-yyyy"><?php echo $yyyy; ?></span>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group select-placeholder">
                                                                    ...
                                                                    <select name="discount_type" class="selectpicker"
                                                                            ...
                                                                            data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                                                                        <option value=""
                                                                                selected><?php echo _l('no_discount'); ?></option>
                                        ...
                                        <div class="panel-body card mt-4">
                                            <div class="row">
                                                <div class="col-md-4">
                                                ...
                                                <div class="col-md-8 text-right show_quantity_as_wrapper">
                                                    <div class="mt-2">
                                                        <span class="mr-2"><?php echo _l('show_quantity_as'); ?> </span>
                                                        ...
                                                        <div class="form-check form-check-inline">
                                                            <label class="form-check-label">
                                                                ...
                                                                <span class="form-check-description"
                                                                      for="sq_1"><?php echo _l('quantity_as_qty'); ?></span>
                                                            </label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <label class="form-check-label">
                                                                ...
                                                                <span class="radio-icon"></span>
                                                                <span class="form-check-description"
                                                                      for="sq_2"><?php echo _l('quantity_as_hours'); ?></span>
                                                            </label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <label class="form-check-label">
                                                                ...
                                                                <span class="radio-icon"></span>
                                                                <span class="form-check-description"
                                                                      for="sq_3"><?php echo _l('credit_note_table_quantity_heading'); ?>
                                                                    /<?php echo _l('credit_note_table_hours_heading'); ?></span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="table-responsive s_table">
                                                <table class="table credite-note-items-table items table-main-credit-note-edit no-mtop">
                                                    ...
                                                    <tr>
                                                        <th></th>
                                                        <th width="20%" align="left"><i
                                                                    class="fa fa-exclamation-circle text-white line-height-25"
                                                                    aria-hidden="true"
                                                                    data-toggle="tooltip"
                                                                    data-title="<?php echo _l('item_description_new_lines_notice'); ?>"></i> <?php echo _l('credit_note_table_item_heading'); ?>
                                                        </th>
                                                        <th width="25%"
                                                            align="left"><?php echo _l('credit_note_table_item_description'); ?></th>
                                                        <?php
                                                        ...
                                                        ?>
                                                        <th width="10%" class="qty"
                                                            align="right"><?php echo $qty_heading; ?></th>
                                                        <th width="15%"
                                                            align="right"><?php echo _l('credit_note_table_rate_heading'); ?></th>
                                                        <th width="20%"
                                                            align="right"><?php echo _l('credit_note_table_tax_heading'); ?></th>
                                                        <th width="10%"
                                                            align="right"><?php echo _l('credit_note_table_amount_heading'); ?></th>
                                                        <th align="center"><i
                                                                    class="fa fa-cog text-white line-height-25"></i>
                                                        </th>
                                                    </tr>
                                                    </thead>
                                                    <tbody>
                                                    <tr class="main">
                                                        ...
                                                        <td>
                                                            ...
                                                            <button type="button"
                                                                    ...
                                                                    class="btn pull-right btn-info min-height-auto m-t-2"><i
                                                                        class="fa fa-check s-4"></i></button>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <?php if (isset($credit_note) || isset($add_items)) {
                                                        ...
                                                        foreach ($add_items as $item) {
                                                            ...
                                                            $table_row .= '<td><div class="btn-group"><a href="#" class="btn btn-danger pull-left min-height-auto m-t-2" onclick="delete_item(this,' . $item['id'] . '); return false;"><i class="fa fa-times s-4"></i></a></div></td>';
                                                            $table_row .= '</tr>';
                                                            echo $table_row;
                                                            $i++;
                                                        }
                                            ...
                                            <div class="col-md-8 col-md-offset-4">
                                                <table class="table text-right">
                                                    <tbody>
                                                    <tr id="subtotal">
                                                        <td><span class="bold"><?php echo _l('credit_note_subtotal'); ?>
                                                                :</span>
                                                        </td>
                                                        <td class="subtotal">
                                                        </td>
           ...
           <span class="discount-total-type-selected">
            ...
            ?>
                                                                                ...
                                                                                <ul class="dropdown-menu"
                                                                                    ...
                                                                                    <li>
                                                                                        <a href="#"
                                                                                           class="discount-total-type discount-type-percent<?php if (!isset($credit_note) || (isset($credit_note) && is_sale_discount($credit_note, 'percent')) || (isset($credit_note) && !is_sale_discount_applied($credit_note))) {
                                                                                               echo ' selected';
                                                                                           } ?>">%</a>
                                                                                    </li>
                                                                                    <li>
                                                                                        <a href="#"
                                                                                           class="discount-total-type discount-type-fixed<?php if (isset($credit_note) && is_sale_discount($credit_note, 'fixed')) {
                                                                                               echo ' selected';
                                                                                           } ?>">
                                                    ...
                                                    <tr>
                                                        <td><span class="bold"><?php echo _l('credit_note_total'); ?>
                                                                :</span>
                                                        </td>
                                                        <td class="total">
                                                        </td>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 mt-4">
                                                <div class="panel-body card bottom-transaction">
                                ...
                                <div class="row credit-note-form-save-buttons">
                                    <div class="col p-0 ml-4">
                                        <button type="button"
                                                class="btn-tr btn btn-info ml-2 credit-note-form-submit save-and-send transaction-submit">
                                            <?php echo _l('save_and_send'); ?>
                                        </button>
                                    </div>
                                    <div class="col p-0 ml-4">
                                        <button class="btn-tr btn btn-info ml-2 credit-note-form-submit transaction-submit">
                                            <?php echo _l('submit'); ?>
                                        </button>
                                    </div>
                                </div>
