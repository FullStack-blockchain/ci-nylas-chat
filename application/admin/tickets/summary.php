               ...
               onclick="dt_custom_view('ticket_status_<?php echo $status['ticketstatusid']; ?>','.tickets-table','ticket_status_<?php echo $status['ticketstatusid']; ?>',true); return false;">
                <div class="fuse-widget-front mat-white-bg mat-elevation-z2 ng-tns-c24-4">
                    <div class="p-6 text-center">
                        <div class="font-size-48 line-height-48"><?php echo total_rows('tbltickets', $_where); ?></div>
                        <div class="h5 f-16 mt-8 font-weight-500"
                             style="color:<?php echo $status['statuscolor']; ?>">
