    ...
    if ($encodeExplorer->dirs) { ?>
        ...
        foreach ($encodeExplorer->dirs as $dir) {
            ...
            <?php
                        ...
                        <?php $normalized = Utils::normalizeName($dirname); ?>

                        <td class="name" data-order="<?php echo $normalized; ?>" data-filter="<?php echo $normalized; ?>">
                            <div class="relative">
                                <a class="full-lenght" href="<?php echo $thislink; ?>">
                                    <span class="icon text-center">
                                        <i class="fa fa-folder fa-lg fa-fw"></i> <?php echo $normalized; ?>
                                    </span>
                                </a>
                                <span class="hover">
            ...
            if ($location->editAllowed()) {
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <li>
                                        <a class="zipdir" 
                                            ...
                                            data-thisname="<?php echo $normalized; ?>">
                                    ...
                                    if ($gateKeeper->isAllowed('delete_dir_enable')) { ?>
                                    <li class="del">
                                        <a href="<?php echo $thisdel; ?>&h=<?php echo $cash; ?>&fa=<?php echo $delquery; ?>" data-name="<?php echo $normalized; ?>">
                                            <i class="fa fa-trash-o"></i> 
                ...
                if ($gateKeeper->isAllowed('delete_dir_enable')) { ?>
                        <td class="del text-center hidden-xs">
                            <a class="round-butt butt-mini" data-name="<?php echo $normalized; ?>" 
