...
class Migration_Version_129 extends CI_Migration
{
    ...
    {
        // Merged to main.js
        if (file_exists(FCPATH . 'assets-old/js/leads.js')) {
            @unlink(FCPATH . 'assets-old/js/leads.js');
        }
        // Merged to main.js
        if (file_exists(FCPATH . 'assets-old/js/newsfeed.js')) {
            @unlink(FCPATH . 'assets-old/js/newsfeed.js');
        }
