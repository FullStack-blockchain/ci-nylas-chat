    ...
    $(function() {
        ...
        $.each($widgets,function(){
            ...
            if(widget.data('name') && widget.html().trim().length > 0) {
                widgetOptionsHTML += '<div class="form-check"><label class="form-check-label">';
                ...
                widgetOptionsHTML += '<input type="checkbox" class="form-check-input widget-visibility" value="'+wID+'" '+checked+' id="widget_option_'+wID+'" name="dashboard_widgets['+wID+']">';
                widgetOptionsHTML += '<span class="checkbox-icon"></span><span class="form-check-description">'+widget.data('name')+'</span>';
                widgetOptionsHTML += '</label></div>';
            }
