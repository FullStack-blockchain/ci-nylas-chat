...
<div class="p-4">
    <div class="row">
        <div class="col-md-4">
            <div class="form-group p-0 select-placeholder">
        ...
        <div class="col-md-8 col-xs-12">
            <div class="text-right _buttons pull-right">
                ...
                <a href="#" id="statement_print" target="_blank" class="btn btn-default btn-with-tooltip btn-icon m-r-5"
                   data-toggle="tooltip" title="<?php echo _l('print'); ?>" data-placement="bottom">
                    <i class="fa fa-print"></i>
                </a>

                <a href="" id="statement_pdf" class="btn btn-default btn-with-tooltip btn-icon m-r-5"
                   data-toggle="tooltip"
                   title="<?php echo _l('view_pdf'); ?>" data-placement="bottom">
                    <i class="fa fa-file-pdf-o"></i>
                </a>

                <a href="#" class="btn btn-default btn-with-tooltip btn-icon" data-toggle="tooltip"
                   data-title="<?php echo _l('send_to_email'); ?>" data-placement="bottom">
                    <span data-toggle="modal" data-target="#statement_send_to_client"><i
        ...
        <div class="col-md-12">
            <h4 class="f-18"><?php echo _l('customer_statement_for', get_company_name($client->userid)); ?></h4>
        </div>
        <div class="clearfix"></div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel"><?php echo _l('account_summary'); ?></h4>
