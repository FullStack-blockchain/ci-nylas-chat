      ...
      <div class="row">
         <div class="col-md-12">
            <h5 class="bold pipeline-heading">
               <a href="<?php echo admin_url('proposals/list_proposals/'.$proposal['id']); ?>" class="f-16 text-dark" data-toggle="tooltip" data-title="<?php echo $proposal['subject']; ?>" onclick="proposal_pipeline_open(<?php echo $proposal['id']; ?>); return false;"><?php echo format_proposal_number($proposal['id']); ?></a>
            ...
            <span class="mb-2 inline-block full-width">
            <?php
            ...
            <div class="row">
               <div class="col-md-8 f-12">
                  <?php if($proposal['total'] != 0){ ?>
                      <p class="bold m-b-5 f-12"><?php echo _l('proposal_total'); ?>: <?php echo format_money($proposal['total'],$this->currencies_model->get($proposal['currency'])->symbol); ?></p>
                  <?php } ?>
