        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <?php if (has_permission('tasks', '', 'delete')) { ?>
                    ...
                    <hr class="mass_delete_separator mt-4"/>
                <?php } ?>
                <div id="bulk_change">
                    ...
                    <?php if (has_permission('tasks', '', 'edit')) { ?>
                        ...
                        <div class="form-group">
                            ...
                            <select name="task_bulk_priority" class="selectpicker" id="task_bulk_priority"
                                    data-width="100%"
                        ...
                        echo '<label for="task_bulk_assignees" class="control-label text-muted mt-4">' . _l('task_assigned') . '<i class="fa fa-question-circle ml-2" data-toggle="tooltip" data-title="' . _l('tasks_bull_actions_assign_notice') . '"></i></label>';
                        echo render_select('task_bulk_assignees', $staff_bulk_assigned, array('staffid', array('firstname', 'lastname')), '', '', array('multiple' => true),[],'pt-0');
                        if (isset($project)) {
