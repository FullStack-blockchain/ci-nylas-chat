                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php if ($event->userid == get_staff_user_id() || is_admin()) { ?>
                            ...
                            <?php echo render_input('title', 'utility_calendar_new_event_placeholder', $event->title, 'text', [], [], 'mb-1'); ?>
                            <?php echo render_textarea('description', 'event_description', $event->description, array('rows' => 5), [], 'mb-0'); ?>
                            <?php echo render_datetime_input('start', 'utility_calendar_new_event_start_date', _dt($event->start), [], [], 'mb-0'); ?>
                            <div class="clearfix mtop15"></div>
                            <?php echo render_datetime_input('end', 'utility_calendar_new_event_end_date', _dt($event->end), [], [], 'mb-0'); ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            <input type="number" class="form-control" name="reminder_before"
                                                   value="<?php echo $event->reminder_before; ?>" id="reminder_before">
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="public" id="event_public" <?php if ($event->public == 1) {echo 'checked';} ?>/>
