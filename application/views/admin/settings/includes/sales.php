    ...
    <div class="horizontal-tabs">
        <ul class="nav nav-tabs nav-tabs-horizontal" role="tablist">
            <li role="presentation" class="nav-item active">
                <a href="#general" class="nav-link" aria-controls="general" role="tab"
                   data-toggle="tab"><?php echo _l('settings_sales_heading_general'); ?></a>
            </li>
            <li role="presentation" class="nav-item">
                <a href="#invoice" class="nav-link" aria-controls="invoice" role="tab"
                   data-toggle="tab"><?php echo _l('invoices'); ?></a>
            </li>
            <li role="presentation" class="nav-item">
                <a href="#credit_notes" class="nav-link" aria-controls="credit_notes" role="tab"
                   data-toggle="tab"><?php echo _l('credit_notes'); ?></a>
            </li>
            <li role="presentation" class="nav-item">
                <a href="#estimates" class="nav-link" aria-controls="estimates" role="tab"
                   data-toggle="tab"><?php echo _l('settings_sales_heading_estimates'); ?></a>
            </li>
            <li role="presentation" class="nav-item">
                <a href="#proposals" class="nav-link" aria-controls="proposals" role="tab"
...
<div class="tab-content">
    <div role="tabpanel" class="tab-pane active" id="general">
        ...
        <div class="form-group">
            ...
            <div class="form-check form-check-inline">
                <label class="form-check-label">
                    <input type="radio" name="settings[currency_placement]" value="before" class="form-check-input"
                           id="c_placement_before" <?php if (get_option('currency_placement') == 'before') {
                        echo 'checked';
                    } ?>>
                    <span class="radio-icon"></span>
                    <span><?php echo _l('settings_sales_currency_placement_before'); ?>
                        ( <?php echo $this->currencies_model->get_base_currency()->symbol; ?>25.00 ) </span>
                </label>
            </div>

            <div class="form-check form-check-inline">
                <label class="form-check-label">
                    <input type="radio" name="settings[currency_placement]" id="c_placement_after" class="form-check-input"
                           value="after" <?php if (get_option('currency_placement') == 'after') {
                        echo 'checked';
                    } ?>>
                    <span class="radio-icon"></span>
                    <span><?php echo _l('settings_sales_currency_placement_after'); ?>
                        ( 25.00<?php echo $this->currencies_model->get_base_currency()->symbol; ?> )</span>
                </label>
            </div>
        </div>
        <hr class="mt-4 mb-4"/>
        ...
        <h4 class="bold f-18"><?php echo _l('settings_amount_to_words'); ?></h4>
    ...
    <div role="tabpanel" class="tab-pane" id="invoice">
        ...
        <div class="form-group">
            ...
            <div class="form-check form-check-inline">
                <label class="form-check-label">
                    <input type="radio" id="number_based" name="settings[invoice_number_format]" class="form-check-input"
                           value="1" <?php if (get_option('invoice_number_format') == '1') {
                        echo 'checked';
                    } ?>>
                    <span class="radio-icon"></span>
                    <span><?php echo _l('settings_sales_invoice_number_format_number_based'); ?></span>
                </label>
            </div>

            <div class="form-check form-check-inline">
                <label class="form-check-label">
                    <input type="radio" name="settings[invoice_number_format]" value="2" class="form-check-input"
                           id="year_based" <?php if (get_option('invoice_number_format') == '2') {
                        echo 'checked';
                    } ?>>
                    <span class="radio-icon"></span>
                    <span><?php echo _l('settings_sales_invoice_number_format_year_based'); ?>
                        (YYYY/000001)</span>
                </label>
            </div>
            ...
            <div class="form-check form-check-inline">
                <label class="form-check-label">
                    <input type="radio" name="settings[invoice_number_format]" value="3" class="form-check-input"
            ...
            <div class="form-check form-check-inline">
                <label class="form-check-label">
                    <input type="radio" name="settings[invoice_number_format]" value="4" class="form-check-input"
                           id="year_month_based" <?php if (get_option('invoice_number_format') == '4') {
                        echo 'checked';
                    } ?>>
                    <span class="radio-icon"></span>
                    <span>000001/MM/YYYY</span>
                </label>
            </div>
    ...
    <div role="tabpanel" class="tab-pane" id="credit_notes">
        ...
        <div class="form-group">
            ...
            <div class="form-check form-check-inline">
                <label class="form-check-label">
                    <input type="radio" name="settings[credit_note_number_format]" value="1" class="form-check-input"
            ...
            <div class="form-check form-check-inline">
                <label class="form-check-label">
                    <input type="radio" name="settings[credit_note_number_format]" value="2" class="form-check-input"
            ...
            <div class="form-check form-check-inline">
                <label class="form-check-label">
                    <input type="radio" name="settings[credit_note_number_format]" value="3" class="form-check-input"
            ...
            <div class="form-check form-check-inline">
                <label class="form-check-label">
                    <input type="radio" name="settings[credit_note_number_format]" value="4" class="form-check-input"
    ...
    <div role="tabpanel" class="tab-pane" id="estimates">
        ...
        <div class="form-group">
            ...
            <div class="form-check form-check-inline">
                <label class="form-check-label">
                    <input type="radio" name="settings[estimate_number_format]" value="1" class="form-check-input"
            ...
            <div class="form-check form-check-inline">
                <label class="form-check-label">
                    <input type="radio" name="settings[estimate_number_format]" value="2" class="form-check-input"
            ...
            <div class="form-check form-check-inline">
                <label class="form-check-label">
                    <input type="radio" name="settings[estimate_number_format]" value="3" class="form-check-input"
            ...
            <div class="form-check form-check-inline">
                <label class="form-check-label">
                    <input type="radio" name="settings[estimate_number_format]" value="4" class="form-check-input"
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <div class="mt-7 text-right">
                    ...
                    <div class="form-check form-check-inline">
                        <label class="form-check-label">
                            <input type="radio" id="k_desc_estimate" name="settings[default_estimates_pipeline_sort_type]" class="form-check-input"
                    ...
                    <div class="form-check form-check-inline">
                        <label class="form-check-label">
                            <input type="radio" id="k_asc_estimate" name="settings[default_estimates_pipeline_sort_type]" class="form-check-input"
