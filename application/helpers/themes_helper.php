...
/**
 * Get current template assets-old url
 * @return string Assets url
 */
function template_assets_url()
{
    return base_url('assets-old/themes/' . get_option('clients_default_theme')) . '/';
}
...
{
    return 'assets-old/themes/' . get_option('clients_default_theme');
}
