...
$staff_mail_list_row = [
    ...
    '--',
    '--',
    '<a href="' . site_url('admin/surveys/mail_list_view/staff') . '" class="btn btn-default btn-icon" ><i class="fa fa-eye line-height-25"></i>',
];
$clients_mail_list_row = [
    ...
    '--',
    '--',
    '<a href="' . site_url('admin/surveys/mail_list_view/clients') . '" class="btn btn-default btn-icon" ><i class="fa fa-eye line-height-25"></i>',
];
$leads_mail_list_row = [
    '--',
    ...
    '--',
    '--',
    '<a href="' . site_url('admin/surveys/mail_list_view/leads') . '" class="btn btn-default btn-icon" ><i class="fa fa-eye line-height-25"></i>',
];
