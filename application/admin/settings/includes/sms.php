...
<div class="panel-group" id="sms_gateways_options" role="tablist" aria-multiselectable="false">
    <?php foreach ($gateways as $gateway) { ?>
        <div class="panel panel-default">
            ...
            <div id="sms_<?php echo $gateway['id']; ?>"
                 class="panel-collapse collapse<?php if ($this->sms->get_option($gateway['id'], 'active') == 1 || $total_gateways == 1) {
                     echo ' in';
    ...
    <hr/>
    <h4 class="mt-4">
        <i class="fa fa-question-circle pull-left mt-1" data-toggle="tooltip"
