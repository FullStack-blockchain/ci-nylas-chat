...
foreach ($rResult as $aRow) {
    ...
    // Bulk actions
    $row[] = '<div class="form-check"><label class="form-check-label"><input type="checkbox" class="form-check-input"  value="' . $aRow['userid'] . '"/><span class="checkbox-icon"></span></label></div>';
    // User id
    $row[] = $aRow['userid'];
    ...
    $toggleActive = '
    <div class="onoffswitch" data-toggle="tooltip" data-title="' . _l('customer_active_inactive_help') . '">
    <label class="switch onoffswitch-label" for="' . $aRow['userid'] . '">
